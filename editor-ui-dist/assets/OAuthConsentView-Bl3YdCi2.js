...
import { E as N8nNotice_default, In as N8nText_default, Ln as N8nButton_default, M as N8nLogo_default, Pn as N8nHeading_default, zn as N8nIcon_default } from "./src-CfTpoyeY.js";
...
import { Sc as STORES, Tn as useDocumentTitle, Zs as useRootStore, bc as defineStore, dc as makeRestApiRequest } from "./useTelemetry-Bj7xGk8p.js";
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style.overlay) }, [createBaseVNode("div", { class: normalizeClass(_ctx.$style["consent-dialog"]) }, [
				...
				createBaseVNode("footer", { class: normalizeClass(_ctx.$style.footer) }, [error.value ? (openBlock(), createBlock(unref(N8nNotice_default), {
					key: 0,
					theme: "danger",
...
const overlay = "_overlay_1dgza_123";
const header = "_header_1dgza_149";
const logo = "_logo_1dgza_155";
const n8n = "_n8n_1dgza_164";
const content = "_content_1dgza_169";
const footer = "_footer_1dgza_199";
