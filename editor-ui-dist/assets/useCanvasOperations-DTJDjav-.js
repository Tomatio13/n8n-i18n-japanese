...
import { M as useLocalStorage, S as useClipboard, yt as useI18n } from "./_MapCache-BSabmsGd.js";
import { Bt as useRoute, Kt as require_markdown_it_link_attributes, Qt as createEventBus, Vt as useRouter } from "./src-9dBEqjNT.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { C as useNodeTypesStore, Cn as doRectsOverlap, Dt as useTagsStore, Ft as useNDVStore, It as injectWorkflowState, Jr as isValidNodeConnectionType, Lt as useWorkflowState, Mt as useTelemetry, Or as v4_default, Qr as CanvasConnectionMode, Tr as usePostHog, Xi as isPresent, _n as CONFIGURATION_NODE_SIZE, _r as useCanvasStore, bn as GRID_SIZE, ci as RemoveConnectionCommand, d as isChatNode, di as ReplaceNodeParametersCommand, ds as useSettingsStore, ei as CanvasNodeRenderType, gr as useExternalHooks, hn as CONFIGURABLE_NODE_SIZE, jn as getNodesGroupSize, jt as useNodeHelpers, kn as getNewNodePosition, li as RemoveNodeCommand, ln as useFocusPanelStore, mn as useTemplatesStore, mr as useToast, ni as AddConnectionCommand, nt as useCredentialsStore, r as useUIStore, ri as AddNodeCommand, s as useWorkflowsStore, si as MoveNodeCommand, st as useDataSchema, ta as tryToParseNumber, ti as useHistoryStore, ui as RenameNodeCommand, vn as DEFAULT_NODE_SIZE, wn as generateOffsets, wt as useWorkflowHelpers, xn as PUSH_NODES_OFFSET, y as getExecutionErrorToastConfiguration, yn as DEFAULT_VIEWPORT_BOUNDARIES, zt as useProjectsStore } from "./users.store-CRuM-6OK.js";
import { $i as getConnectionTypes, Dc as EnterpriseEditionFeature, Dn as MCP_TRIGGER_NODE_TYPE, Hs as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, Oa as deepCopy, Si as require_cloneDeep, Us as LOCAL_STORAGE_LOGS_PANEL_OPEN, Vs as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, Wo as VIEWS, Ws as LOCAL_STORAGE_LOGS_SYNC_SELECTION, Xi as generateNodesGraph, _r as WEBHOOK_NODE_TYPE, ea as getNodeInputs, hr as UPDATE_WEBHOOK_ID_NODE_TYPES, ji as require__baseUniq, ka as isCommunityPackageName, lr as STICKY_NODE_TYPE, na as getNodeParameters, pc as CANVAS_ZOOMED_VIEW_EXPERIMENT, qa as NodeConnectionTypes, sa as getSubworkflowId, ta as getNodeOutputs, un as FORM_TRIGGER_NODE_TYPE, vc as NDV_IN_FOCUS_PANEL_EXPERIMENT } from "./constants-jSlGi3TV.js";
import { A as defineStore, r as useRootStore } from "./_baseOrderBy-DymvjUPt.js";
...
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-B46ithaJ.js";
