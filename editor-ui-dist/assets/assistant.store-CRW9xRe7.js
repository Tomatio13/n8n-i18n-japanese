...
import { dt as isWorkflowUpdatedMessage, ut as isToolMessage } from "./src-DEMmv7aL.js";
import { x as createEventBus, y as useRoute } from "./truncate-Zm7rqMgr.js";
import { Fi as codeNodeEditorEventBus, Ht as useCredentialsStore, Js as useRootStore, Jt as getSessionsMetadata, Kt as getAiSessions, Li as useUIStore, Sn as injectWorkflowState, Ti as stringSizeInBytes, Tn as require_pick, Ut as chatWithAssistant, Wt as chatWithBuilder, Xr as getAuthTypeForNodeCredential, Xt as useAIAssistantHelpers, Yt as replaceCode, Zr as getMainAuthField, a as useNDVStore, fc as assert, gc as defineStore, ir as useUsersStore, ko as CREDENTIAL_EDIT_MODAL_KEY, o as useWorkflowsStore, qt as getBuilderCredits, rt as useNodeTypesStore, t as useTelemetry, vc as STORES, zo as useSettingsStore } from "./useTelemetry-DMMCGp2b.js";
import { t as useToast } from "./useToast-C1ZpPbXg.js";
import { At as DEFAULT_NEW_WORKFLOW_NAME, Vt as EDITABLE_CANVAS_VIEWS, oa as VIEWS, ri as PLACEHOLDER_EMPTY_WORKFLOW_ID, ws as jsonParse, xs as deepCopy } from "./constants-yBDcqULv.js";
