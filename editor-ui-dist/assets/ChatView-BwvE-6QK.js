const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-BIpU_cIy.js","assets/core-XmFv11t6.js","assets/chunk-r2Y0G7H8.js","assets/languageModules-C_OUTvyN.js","assets/xml-BMqNMrYo.js"])))=>i.map(i=>d[i]);
...
import { D as useElementSize, F as useScroll, L as useSpeechRecognition, M as useLocalStorage, N as useMediaQuery, R as useSpeechSynthesis, bt as I18nT, yt as useI18n } from "./_MapCache-DzvtSRAp.js";
...
import { Or as v4_default, ds as useSettingsStore, mr as useToast, on as useDocumentTitle, r as useUIStore, s as useWorkflowsStore, t as useUsersStore } from "./users.store-B8MNpFK1.js";
import "./sanitize-html-Bm7Ej2cW.js";
import { As as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL, Jr as PROVIDER_CREDENTIAL_TYPE_MAP, Vo as VIEWS, Xr as chatHubConversationModelSchema, fi as INodesSchema, js as LOCAL_STORAGE_CHAT_HUB_SELECTED_TOOLS } from "./constants-Bpgtcge2.js";
...
import { t as VueMarkdown_default } from "./VueMarkdown-CI37TdsP.js";
import "./CredentialIcon-DRR0Dbh7.js";
import "./NodeIcon-BLfujgfP.js";
import { _ as TOOLS_SELECTOR_MODAL_KEY, h as MOBILE_MEDIA_QUERY, l as CHAT_VIEW, n as CHAT_CONVERSATION_VIEW, t as AGENT_EDITOR_MODAL_KEY, v as providerDisplayNames } from "./constants-TIcoOiKB.js";
import { _ as unflattenModel, a as findOneFromModelsResponse, d as isEditable, f as isLlmProvider, m as isRegenerable, p as isLlmProviderModel, r as createMimeTypes, t as useChatStore, y as buildChatAttachmentUrl } from "./chat.store-DRZcPteY.js";
import { t as ChatAgentAvatar_default } from "./ChatAgentAvatar-c7HLRQFo.js";
import { t as ChatFile_default } from "./ChatFile-CK6UREaX.js";
import { n as ToolsSelector_default, r as ModelSelector_default, t as useCustomAgent } from "./useCustomAgent-Cjf_oHuH.js";
import { n as useChatCredentials, r as chatHubConversationModelWithCachedDisplayNameSchema, t as ChatLayout_default } from "./ChatLayout-CfS5mTwt.js";
...
function useChatHubMarkdownOptions(codeBlockActionsClassName, tableContainerClassName) {
	...
	async function loadLanguageModules() {
		...
		try {
			asyncImport = {
				status: "inProgress",
				promise: Promise.all([__vitePreload(() => import("./es-BIpU_cIy.js"), __vite__mapDeps([0,1,2])), __vitePreload(() => import("./languageModules-C_OUTvyN.js"), __vite__mapDeps([3,4]))])
			};
