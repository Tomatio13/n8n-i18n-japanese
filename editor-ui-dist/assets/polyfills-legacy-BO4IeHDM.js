(function() {
	...
	var require_set_helpers = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = {
			Set,
			add: uncurryThis$16(SetPrototype$1.add),
			has: uncurryThis$16(SetPrototype$1.has),
			remove: uncurryThis$16(SetPrototype$1["delete"]),
	...
	var require_set_iterate = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var forEach$1 = uncurryThis$15(SetPrototype.forEach);
		var keys = uncurryThis$15(SetPrototype.keys);
	...
	var require_well_known_symbol_define = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(NAME$1) {
			...
			if (!hasOwn$10(Symbol$4, NAME$1)) defineProperty$3(Symbol$4, NAME$1, { value: wrappedWellKnownSymbolModule.f(NAME$1) });
		};
	}));
	...
	var Symbol$2 = globalThis$26.Symbol;
	defineWellKnownSymbol$1("asyncDispose");
	if (Symbol$2) {
		var descriptor$2 = getOwnPropertyDescriptor$2(Symbol$2, "asyncDispose");
	...
	var Symbol$1 = globalThis$25.Symbol;
	defineWellKnownSymbol("dispose");
	if (Symbol$1) {
		var descriptor$1 = getOwnPropertyDescriptor$1(Symbol$1, "dispose");
	...
	var NativeSuppressedError = globalThis$24.SuppressedError;
	var TO_STRING_TAG$1 = wellKnownSymbol$4("toStringTag");
	var $Error = Error;
	var WRONG_ARITY = !!NativeSuppressedError && NativeSuppressedError.length !== 3;
	var EXTRA_ARGS_SUPPORT = !!NativeSuppressedError && fails$6(function() {
	...
	var $SuppressedError = function SuppressedError(error, suppressed, message) {
		...
		var that;
		if (setPrototypeOf$2) that = PATCH && (!isInstance || getPrototypeOf$2(this) === SuppressedErrorPrototype) ? new NativeSuppressedError() : setPrototypeOf$2(new $Error(), isInstance ? getPrototypeOf$2(this) : SuppressedErrorPrototype);
		else {
			that = isInstance ? this : create$1(SuppressedErrorPrototype);
			createNonEnumerableProperty$2(that, TO_STRING_TAG$1, "Error");
		}
		if (message !== void 0) createNonEnumerableProperty$2(that, "message", normalizeStringArgument$1(message));
	...
	if (PATCH && !IS_PURE$5) SuppressedErrorPrototype.constructor = $SuppressedError;
	$$14({
		global: true,
		constructor: true,
		arity: 3,
	...
	var require_array_buffer_byte_length = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var ArrayBuffer$2 = globalThis$23.ArrayBuffer;
		var TypeError$4 = globalThis$23.TypeError;
	...
	var require_array_buffer_is_detached = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var DataView$2 = globalThis$22.DataView;
	...
	var require_environment = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = (function() {
			...
			if (globalThis$21.Bun && typeof Bun.version == "string") return "BUN";
			if (globalThis$21.Deno && typeof Deno.version == "object") return "DENO";
			if (classof$5(globalThis$21.process) === "process") return "NODE";
			if (globalThis$21.window && globalThis$21.document) return "BROWSER";
			return "REST";
		})();
	}));
	...
	var require_get_built_in_node_module = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(name) {
			if (IS_NODE$1) {
				try {
					return globalThis$20.process.getBuiltinModule(name);
				} catch (error) {}
				try {
	...
	var require_structured_clone_proper_transfer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var structuredClone$2 = globalThis$19.structuredClone;
	...
	var require_detach_transferable = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var structuredClone$1 = globalThis$18.structuredClone;
		var $ArrayBuffer = globalThis$18.ArrayBuffer;
		var $MessageChannel = globalThis$18.MessageChannel;
		var detach = false;
	...
	var require_array_buffer_transfer = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var slice$2 = uncurryThis$10(ArrayBufferPrototype.slice);
	...
	if (!hasOwn$9(IteratorPrototype, DISPOSE)) defineBuiltIn$3(IteratorPrototype, DISPOSE, function() {
		var $return = getMethod$1(this, "return");
		if ($return) call$6($return, this);
	});
	...
	var require_async_iterator_prototype = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var AsyncIterator = globalThis$16.AsyncIterator;
		var PassedAsyncIteratorPrototype = shared.AsyncIteratorPrototype;
		var AsyncIteratorPrototype$1, prototype;
		if (PassedAsyncIteratorPrototype) AsyncIteratorPrototype$1 = PassedAsyncIteratorPrototype;
		else if (isCallable$7(AsyncIterator)) AsyncIteratorPrototype$1 = AsyncIterator.prototype;
		else if (shared[USE_FUNCTION_CONSTRUCTOR] || globalThis$16[USE_FUNCTION_CONSTRUCTOR]) try {
		...
		if (!isCallable$7(AsyncIteratorPrototype$1[ASYNC_ITERATOR])) defineBuiltIn$2(AsyncIteratorPrototype$1, ASYNC_ITERATOR, function() {
			return this;
		});
	...
	if (!hasOwn$8(AsyncIteratorPrototype, ASYNC_DISPOSE)) defineBuiltIn$1(AsyncIteratorPrototype, ASYNC_DISPOSE, function() {
		var O = this;
		return new Promise$1(function(resolve, reject) {
			var $return = getMethod(O, "return");
			if ($return) Promise$1.resolve(call$3($return, O)).then(function() {
				resolve(void 0);
			}, reject);
			else resolve(void 0);
		});
	...
	var require_array_buffer_view_core = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var Int8Array$1 = globalThis$15.Int8Array;
		var Int8ArrayPrototype = Int8Array$1 && Int8Array$1.prototype;
		var Uint8ClampedArray = globalThis$15.Uint8ClampedArray;
		...
		var NATIVE_ARRAY_BUFFER_VIEWS = NATIVE_ARRAY_BUFFER && !!setPrototypeOf$1 && classof$4(globalThis$15.opera) !== "Opera";
		...
		var aTypedArrayConstructor = function(C) {
			if (isCallable$6(C) && (!setPrototypeOf$1 || isPrototypeOf$1(TypedArray, C))) return C;
		...
		var exportTypedArrayMethod$1 = function(KEY, property, forced, options) {
			...
			if (forced) for (var ARRAY in TypedArrayConstructorsList) {
				var TypedArrayConstructor = globalThis$15[ARRAY];
		...
		var exportTypedArrayStaticMethod = function(KEY, property, forced) {
			...
			if (setPrototypeOf$1) {
				if (forced) for (ARRAY in TypedArrayConstructorsList) {
					TypedArrayConstructor = globalThis$15[ARRAY];
		...
		for (NAME in TypedArrayConstructorsList) {
			Constructor = globalThis$15[NAME];
		...
		if (!NATIVE_ARRAY_BUFFER_VIEWS || !isCallable$6(TypedArray) || TypedArray === Function.prototype) {
			...
			if (NATIVE_ARRAY_BUFFER_VIEWS) {
				for (NAME in TypedArrayConstructorsList) if (globalThis$15[NAME]) setPrototypeOf$1(globalThis$15[NAME], TypedArray);
			}
		}
		if (!NATIVE_ARRAY_BUFFER_VIEWS || !TypedArrayPrototype || TypedArrayPrototype === ObjectPrototype) {
			TypedArrayPrototype = TypedArray.prototype;
			if (NATIVE_ARRAY_BUFFER_VIEWS) {
				for (NAME in TypedArrayConstructorsList) if (globalThis$15[NAME]) setPrototypeOf$1(globalThis$15[NAME].prototype, TypedArrayPrototype);
			}
		}
		if (NATIVE_ARRAY_BUFFER_VIEWS && getPrototypeOf(Uint8ClampedArrayPrototype) !== TypedArrayPrototype) setPrototypeOf$1(Uint8ClampedArrayPrototype, TypedArrayPrototype);
		if (DESCRIPTORS$2 && !hasOwn$7(TypedArrayPrototype, TO_STRING_TAG)) {
			...
			for (NAME in TypedArrayConstructorsList) if (globalThis$15[NAME]) createNonEnumerableProperty$1(globalThis$15[NAME], TYPED_ARRAY_TAG, NAME);
		}
		module.exports = {
	...
	var JSON$1 = globalThis$14.JSON;
	var Number = globalThis$14.Number;
	var SyntaxError$3 = globalThis$14.SyntaxError;
	...
	var internalizeProperty = function(object, key$1, value) {
		if (DESCRIPTORS$1) {
			var descriptor$3 = getOwnPropertyDescriptor(object, key$1);
	...
	var require_uint8_from_base64 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var SyntaxError$2 = globalThis$13.SyntaxError;
		var TypeError$2 = globalThis$13.TypeError;
	...
	(/* @__PURE__ */ __commonJSMin((() => {
		...
		var Uint8Array$4 = globalThis$12.Uint8Array;
	...
	var require_uint8_from_hex = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var Uint8Array$3 = globalThis$11.Uint8Array;
		var SyntaxError$1 = globalThis$11.SyntaxError;
		var parseInt$1 = globalThis$11.parseInt;
		var min = Math.min;
		var NOT_HEX = /[^\da-f]/i;
		var exec$1 = uncurryThis$6(NOT_HEX.exec);
	...
	(/* @__PURE__ */ __commonJSMin((() => {
		...
		var Uint8Array$1 = globalThis$8.Uint8Array;
