const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-C2DNxuAa.js","assets/core-BMwklDiH.js","assets/chunk-6z4oVpB-.js","assets/languageModules-D_uyjb6R.js","assets/xml-B6veOr9z.js"])))=>i.map(i=>d[i]);
...
import { Dr as useUsersStore, N as useWorkflowsStore, Yn as useDocumentTitle, fs as v4_default, gs as useSettingsStore, oa as useUIStore, v as useToast } from "./builder.store-BKBgS0LR.js";
import "./empty-BUjCyq3U.js";
import "./sanitize-html-BkT1y0bJ.js";
import "./CalendarDate-zWqgZMlk.js";
import { Bo as VIEWS, Os as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL, Yr as PROVIDER_CREDENTIAL_TYPE_MAP, Zr as chatHubConversationModelSchema, ks as LOCAL_STORAGE_CHAT_HUB_SELECTED_TOOLS, pi as INodesSchema } from "./constants-Boli8QrC.js";
...
import { t as VueMarkdown_default } from "./VueMarkdown-CbpGJ5dV.js";
...
import { h as buildChatAttachmentUrl, i as findOneFromModelsResponse, l as isLlmProvider, n as createMimeTypes, p as unflattenModel, t as useChatStore, u as isLlmProviderModel } from "./chat.store-CzLyyRta.js";
import "./fileUtils-Bt1vr1SC.js";
import { n as ToolsSelector_default, r as ModelSelector_default, t as useCustomAgent } from "./useCustomAgent-9Tbdfq2T.js";
import { t as ChatAgentAvatar_default } from "./ChatAgentAvatar-BC_mlY3o.js";
import { n as useChatCredentials, r as chatHubConversationModelWithCachedDisplayNameSchema, t as ChatLayout_default } from "./ChatLayout-4JgTbmtd.js";
...
function useChatHubMarkdownOptions(codeBlockActionsClassName, tableContainerClassName) {
	...
	async function loadLanguageModules() {
		...
		try {
			asyncImport = {
				status: "inProgress",
				promise: Promise.all([__vitePreload(() => import("./es-C2DNxuAa.js"), __vite__mapDeps([0,1,2])), __vitePreload(() => import("./languageModules-D_uyjb6R.js"), __vite__mapDeps([3,4]))])
			};
