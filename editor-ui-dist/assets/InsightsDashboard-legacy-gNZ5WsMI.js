;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-8OcfWMWH.js", "./src-legacy-CqaaMy6r.js", "./en-legacy-DJK4SpPN.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-COQs_hNk.js", "./icon-legacy-BBcLFUR7.js", "./overlay-legacy-C5eIW3LW.js", "./empty-legacy-DFAcggMu.js", "./dialog-legacy-D14RDI0B.js", "./useTelemetry-legacy-DRbFTEPe.js", "./useToast-legacy-DFHug49l.js", "./sanitize-html-legacy-C2e3AnhY.js", "./CalendarDate-legacy-BUvNgcoo.js", "./constants-legacy-BnN5j0Of.js", "./merge-legacy-Bk31cAi2.js", "./_baseOrderBy-legacy-Helkyheh.js", "./dateformat-legacy-COtwsT2o.js", "./useDebounce-legacy-vbPtOpN1.js", "./useExternalHooks-legacy-cRYXgFRw.js", "./useStyles-legacy-CBz5KLcN.js", "./cloudPlan.store-legacy-DSxOgyF2.js", "./versions.store-legacy-B7m78ucL.js", "./usePageRedirectionHelper-legacy-C60tsIw7.js", "./ProjectIcon-legacy-DsPdE64l.js", "./orderBy-legacy-DTSArd3g.js", "./ProjectSharing-legacy-CKyiJvE2.js", "./insights.store-legacy-Dz7NqYYF.js", "./insights.constants-legacy-CHokosPb.js", "./insights.utils-legacy-YiCzPlYL.js", "./smartDecimal-legacy-3qxBuZED.js", "./InsightsSummary-legacy-BfOSk6fH.js"], function (_export, _context) {
    "use strict";
    ...
    return {
      ...
      }, function (_constantsLegacy00VJs) {}, function (_mergeLegacy00XJs) {}, function (_baseOrderByLegacy00$Js) {}, function (_dateformatLegacy011Js) {}, function (_useDebounceLegacy013Js) {}, function (_useExternalHooksLegacy015Js) {}, function (_useStylesLegacy017Js) {}, function (_cloudPlanStoreLegacy01fJs) {}, function (_versionsStoreLegacy01NJs) {}, function (_usePageRedirectionHelperLegacy01PJs) {
        usePageRedirectionHelper = _usePageRedirectionHelperLegacy01PJs.t;
      }, function (_ProjectIconLegacy02hJs) {}, function (_orderByLegacy02XJs) {}, function (_ProjectSharingLegacy02ZJs) {
        ProjectSharing_default = _ProjectSharingLegacy02ZJs.t;
      }, function (_insightsStoreLegacy03fJs) {
        useInsightsStore = _insightsStoreLegacy03fJs.t;
      }, function (_insightsConstantsLegacy03hJs) {
        INSIGHT_TYPES = _insightsConstantsLegacy03hJs.s;
      }, function (_insightsUtilsLegacy03jJs) {
        timeRangeMappings = _insightsUtilsLegacy03jJs.i;
        getTimeRangeLabels = _insightsUtilsLegacy03jJs.r;
        formatDateRange = _insightsUtilsLegacy03jJs.t;
      ...
      execute: function () {
        ...
        InsightsDashboard_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            const InsightsPaywall = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsPaywall-legacy-D5Gh_10p.js"), true               ? void 0 : void 0));
            const InsightsChartTotal = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartTotal-legacy-Dx5EIffO.js"), true               ? void 0 : void 0));
            const InsightsChartFailed = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartFailed-legacy-TBcM3e44.js"), true               ? void 0 : void 0));
            const InsightsChartFailureRate = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartFailureRate-legacy-CcDCjqhP.js"), true               ? void 0 : void 0));
            const InsightsChartTimeSaved = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartTimeSaved-legacy-BD64cnPA.js"), true               ? void 0 : void 0));
            const InsightsChartAverageRuntime = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartAverageRuntime-legacy-CeJ87hN5.js"), true               ? void 0 : void 0));
            const InsightsTableWorkflows = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsTableWorkflows-legacy-vqQ4D-EG.js"), true               ? void 0 : void 0));
            const props = __props;
