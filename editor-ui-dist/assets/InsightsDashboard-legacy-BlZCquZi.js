;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-CSbUIQNN.js", "./src-legacy-Bw3jlBBM.js", "./en-legacy-s6H-lEA2.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-BXBaeAHj.js", "./icon-legacy-G70PJc8a.js", "./overlay-legacy-Cejp9MX-.js", "./empty-legacy-CsIOGMHW.js", "./dialog-legacy-CsL9ALTk.js", "./useTelemetry-legacy-K-mG0KNq.js", "./useToast-legacy-BNFd7XMO.js", "./sanitize-html-legacy-Cack6L-S.js", "./path-browserify-legacy-BQKq4wLb.js", "./constants-legacy-CvA6xS_6.js", "./merge-legacy-B2foMX1A.js", "./useRootStore-legacy-BMRt4TVg.js", "./dateformat-legacy-BaeIHy_2.js", "./useDebounce-legacy-CQgGMAey.js", "./useExternalHooks-legacy-JPDKkvXd.js", "./useStyles-legacy-DnD2qvTK.js", "./cloudPlan.store-legacy-GVLMfBwn.js", "./versions.store-legacy-KLktKWcV.js", "./usePageRedirectionHelper-legacy-BooUGPfI.js", "./ProjectIcon-legacy-DOA7aXDu.js", "./orderBy-legacy-DpgU2Zh_.js", "./ProjectSharing-legacy-Czquz9Tz.js", "./insights.store-legacy-DDERScnh.js", "./insights.constants-legacy-Cw1kp4kH.js", "./insights.utils-legacy-8QuZWCxI.js", "./smartDecimal-legacy-D0tIAr6q.js", "./InsightsSummary-legacy-vy2QHREw.js"], function (_export, _context) {
    "use strict";
    ...
    return {
      ...
      execute: function () {
        ...
        InsightsDashboard_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            const InsightsPaywall = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsPaywall-legacy-B8KtJj2k.js"), true               ? void 0 : void 0));
            const InsightsChartTotal = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartTotal-legacy-DcWjKvJn.js"), true               ? void 0 : void 0));
            const InsightsChartFailed = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartFailed-legacy-CoCtbGN7.js"), true               ? void 0 : void 0));
            const InsightsChartFailureRate = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartFailureRate-legacy-DYuLt7Mq.js"), true               ? void 0 : void 0));
            const InsightsChartTimeSaved = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartTimeSaved-legacy-DbnoJo1m.js"), true               ? void 0 : void 0));
            const InsightsChartAverageRuntime = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartAverageRuntime-legacy-D60MZX4H.js"), true               ? void 0 : void 0));
            const InsightsTableWorkflows = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsTableWorkflows-legacy-BYlqWUzG.js"), true               ? void 0 : void 0));
            const props = __props;
