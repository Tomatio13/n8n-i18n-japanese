const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-nIY3oRbS.js","assets/index-NJL4IKW7.js","assets/index-B7wrqKiF.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-CTK6s2IS.js","assets/chartjs.utils-D7LpIn0z.js","assets/InsightsSummary-BgS6pza8.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-CR-EcTxz.js","assets/InsightsChartFailed-DEmZLxQN.js","assets/InsightsChartFailureRate-CmNOjKMh.js","assets/InsightsChartTimeSaved-BuTJJBSN.js","assets/InsightsChartAverageRuntime-DKsAaCwt.js","assets/InsightsTableWorkflows-Bs5471u_.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, ek as useModel, gh as useInsightsStore, gr as getTimeRangeLabels, r as ref, h9 as UNLICENSED_TIME_RANGE, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, ed as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, ec as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, ha as ElDialog, aB as usePageRedirectionHelper, _ as _export_sfc, a3 as useRoute, hb as INSIGHT_TYPES, dx as defineAsyncComponent, a8 as watch, o as onMounted, ay as useDocumentTitle, m as N8nHeading, n as normalizeClass, dN as _sfc_main$4, c5 as resolveDynamicComponent, aV as __vitePreload, am as useTelemetry, hc as TELEMETRY_TIME_RANGE } from "./index-NJL4IKW7.js";
import { I as InsightsSummary } from "./InsightsSummary-BgS6pza8.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-nIY3oRbS.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-CTK6s2IS.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-DEmZLxQN.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-CmNOjKMh.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-BuTJJBSN.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-DKsAaCwt.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-Bs5471u_.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
