...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./useTelemetry-legacy-DyFWt8gD.js"], function (_export, _context) {
    ...
    var computed, reactive, useSettingsStore, registerCommunityEdition, activateLicenseKey, requestLicenseTrial, renewLicense, useRootStore, defineStore, getLicense, DEFAULT_PLAN_NAME, DEFAULT_STATE, useUsageStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        registerCommunityEdition = _useTelemetryLegacy00FJs.Jo;
        activateLicenseKey = _useTelemetryLegacy00FJs.Ko;
        requestLicenseTrial = _useTelemetryLegacy00FJs.Xo;
        renewLicense = _useTelemetryLegacy00FJs.Yo;
        useRootStore = _useTelemetryLegacy00FJs.Zs;
        defineStore = _useTelemetryLegacy00FJs.bc;
        getLicense = _useTelemetryLegacy00FJs.qo;
      }],
      execute: function () {
