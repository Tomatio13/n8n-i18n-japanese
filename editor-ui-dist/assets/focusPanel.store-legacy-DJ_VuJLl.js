;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-CVC6di38.js", "./truncate-legacy-BWR_lVFz.js", "./useTelemetry-legacy-DyFWt8gD.js", "./constants-legacy-DAaX1J_j.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, ref, watchOnce, i18n, require_get, STORES, defineStore, useWorkflowsStore, useNodeTypesStore, useStorage, jsonParse, extractFromAICalls, FROM_AI_AUTO_GENERATED_MARKER, LOCAL_STORAGE_FOCUS_PANEL, PLACEHOLDER_EMPTY_WORKFLOW_ID, NODE_DENYLIST, PATH_DENYLIST, PROP_TYPE_DENYLIST, fromAIExtraProps, import_get, DEFAULT_PANEL_WIDTH, DEFAULT_FOCUS_PANEL_DATA, useFocusPanelStore;
