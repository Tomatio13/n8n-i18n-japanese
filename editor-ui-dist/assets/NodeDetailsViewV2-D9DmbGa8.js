import { d as defineComponent, x as computed, c as useI18n, h as createElementBlock, g as openBlock, j as createBaseVNode, i as createVNode, n as normalizeClass, e as createBlock, f as createCommentVNode, bR as _sfc_main$3, as as InlineRename, l as unref, a1 as N8nLink, w as withCtx, p as N8nText, k as createTextVNode, t as toDisplayString, N as N8nIcon, $ as N8nTooltip, a0 as _sfc_main$4, _ as _export_sfc, r as ref, ij as LOCAL_STORAGE_NDV_PANEL_WIDTH, cZ as toValue, cY as useElementSize, aa as watch, bV as toRef, en as jsonParse, hl as Draggable, ik as FontAwesomeIcon, aM as useNDVStore, bD as useNodeHelpers, fh as storeToRefs, bB as usePinnedData, bI as useNodeTypesStore, T as useUIStore, a4 as useWorkflowsStore, v as useSettingsStore, dP as useDeviceSupport, ar as useTemplateRef, dY as getNodeOutputs, bq as NodeConnectionTypes, bJ as START_NODE_TYPE, i8 as EXECUTABLE_TRIGGER_NODE_TYPES, aS as STICKY_NODE_TYPE, ap as EnterpriseEditionFeature, o as onMounted, gq as dataPinningEventBus, I as onBeforeUnmount, P as normalizeStyle, cb as useStyles, e7 as getNodeIconSource, Q as createEventBus, ca as N8nResizeWrapper, i9 as APP_MODALS_ELEMENT_ID, cE as Teleport, ay as useTelemetry, aA as useMessage, aB as MODAL_CONFIRM, bf as useExternalHooks } from "./index-xrDj6cyN.js";
import { _ as __unplugin_components_0, T as TriggerPanel, I as InputPanel, O as OutputPanel } from "./TriggerPanel-D5cTpsmA.js";
import { a as useNodeDocsUrl, N as NodeSettings } from "./NodeView-B6nb4Pu8.js";
import { u as useKeybindings } from "./useKeybindings-78Ud-8Za.js";
import { u as useWorkflowActivate } from "./useWorkflowActivate-D40IJCqR.js";
import "./RunData-CJ-61Pxj.js";
import "./FileSaver.min-CPXivumC.js";
import "./useExecutionHelpers-TeqoYqyl.js";
import "./RunDataParsedAiContent-C47PaVZv.js";
import "./InfoAccordion-3o-kJFRZ.js";
import "./ActionDropdown-FhrWWR3u.js";
import "./import-curl-Bf8KIhEj.js";
import "./global-link-actions-BseoREG6.js";
import "./useExecutionDebugging-K1xj2XaM.js";
import "./useBeforeUnload-BRw6c-57.js";
