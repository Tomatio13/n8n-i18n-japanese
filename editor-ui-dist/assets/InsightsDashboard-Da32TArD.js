const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-DJTrpol_.js","assets/index-CAwQV-nq.js","assets/index-pk1znPBP.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-BIgeTjYU.js","assets/chartjs.utils-BGN5nOgP.js","assets/InsightsSummary-BhwFAN1t.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-MTZBC0Jo.js","assets/InsightsChartFailed-4WL3kGFh.js","assets/InsightsChartFailureRate-5fQTv5oP.js","assets/InsightsChartTimeSaved-DS_VOK5f.js","assets/InsightsChartAverageRuntime-Cjv5WjEd.js","assets/InsightsTableWorkflows-00G5wRZw.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, eq as useModel, gl as useInsightsStore, gv as getTimeRangeLabels, r as ref, hf as UNLICENSED_TIME_RANGE, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, eh as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, eg as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hg as ElDialog, aB as usePageRedirectionHelper, _ as _export_sfc, a3 as useRoute, av as useProjectsStore, hh as INSIGHT_TYPES, dA as defineAsyncComponent, a8 as watch, o as onMounted, ay as useDocumentTitle, b2 as onBeforeMount, m as N8nHeading, n as normalizeClass, fM as ProjectSharing, dR as _sfc_main$4, c9 as resolveDynamicComponent, aV as __vitePreload, am as useTelemetry, hi as TELEMETRY_TIME_RANGE } from "./index-CAwQV-nq.js";
import { I as InsightsSummary } from "./InsightsSummary-BhwFAN1t.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-DJTrpol_.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-BIgeTjYU.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-4WL3kGFh.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-5fQTv5oP.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-DS_VOK5f.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-Cjv5WjEd.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-00G5wRZw.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
