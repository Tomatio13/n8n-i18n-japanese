...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    const LazyRunDataTable = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataTable-HA6jASWu.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0)
    );
    const LazyRunDataJson = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataJson-RDplXP4B.js"), true ? __vite__mapDeps([6,1,2,7,3,4,8]) : void 0)
    );
    const LazyRunDataSchema = defineAsyncComponent(
      async () => await __vitePreload(() => import("./index-bHaUIFge.js").then((n) => n.i5), true ? __vite__mapDeps([1,2]) : void 0)
    );
    ...
    const LazyRunDataAi = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataParsedAiContent-CLSGMQDd.js"), true ? __vite__mapDeps([9,1,2,7,3,4,10]) : void 0)
    );
    const LazyRunDataSearch = defineAsyncComponent(
      async () => await __vitePreload(() => import("./RunDataSearch-CqDHjyae.js"), true ? __vite__mapDeps([11,1,2,12]) : void 0)
    );
    const props = __props;
    const emit = __emit;
