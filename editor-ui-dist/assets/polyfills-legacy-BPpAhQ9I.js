(function() {
	...
	$$27({
		...
		return new IteratorProxy$1(getIteratorDirect$8(this), { mapper });
	} });
	...
	var require_get_iterator = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(argument, usingIterator) {
			...
			if (aCallable$7(iteratorMethod)) return anObject$11(call$13(iteratorMethod, argument));
	...
	$$25({
		...
		if (everyWithoutClosingOnEarlyError) return call$10(everyWithoutClosingOnEarlyError, this, predicate);
	...
	$$14({
		...
		if (forEachWithoutClosingOnEarlyError) return call$4(forEachWithoutClosingOnEarlyError, this, fn);
