  ...
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-CVC6di38.js", "./src-legacy-DaU7H7T8.js", "./en-legacy-Bgme8Vbm.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-BWR_lVFz.js", "./icon-legacy-BEgY2guO.js", "./empty-legacy-DnVUoqbC.js", "./useTelemetry-legacy-DyFWt8gD.js", "./useToast-legacy-CQPpmrHA.js", "./sanitize-html-legacy-DfOUEbdf.js", "./path-browserify-legacy-DJbEMZcd.js", "./constants-legacy-DAaX1J_j.js", "./merge-legacy-BzTgy7Qd.js", "./dateformat-legacy-Xt1X-tys.js", "./useDebounce-legacy-B8ZMAqF7.js", "./useExternalHooks-legacy-BUVgQPZx.js", "./mcp.constants-legacy-CZfk8DW2.js"], function (_export, _context) {
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        makeRestApiRequest = _useTelemetryLegacy00FJs.dc;
      ...
      execute: function () {
        ...
        __vite_style__.textContent = "/* BEM support Func\n -------------------------- */\n/* Transition\n-------------------------- */\n/* Color\n-------------------------- */\n/* Link\n-------------------------- */\n/* Border\n-------------------------- */\n/* Outline\n-------------------------- */\n/* Box shadow\n-------------------------- */\n/* Fill\n-------------------------- */\n/* Typography\n-------------------------- */\n/* z-index\n-------------------------- */\n/* Disable base\n-------------------------- */\n/* Icon\n-------------------------- */\n/* Checkbox\n-------------------------- */\n/* Radio\n-------------------------- */\n/* Select\n-------------------------- */\n/* Alert\n-------------------------- */\n/* MessageBox\n-------------------------- */\n/* Message\n-------------------------- */\n/* Notification\n-------------------------- */\n/* Input\n-------------------------- */\n/* Cascader\n-------------------------- */\n/* Group\n-------------------------- */\n/* Tab\n-------------------------- */\n/* Button\n-------------------------- */\n/* cascader\n-------------------------- */\n/* Switch\n-------------------------- */\n/* Dialog\n-------------------------- */\n/* Table\n-------------------------- */\n/* Pagination\n-------------------------- */\n/* Popup\n-------------------------- */\n/* Popover\n-------------------------- */\n/* Tooltip\n-------------------------- */\n/* Tag\n-------------------------- */\n/* Tree\n-------------------------- */\n/* Dropdown\n-------------------------- */\n/* Badge\n-------------------------- */\n/* Card\n--------------------------*/\n/* Slider\n--------------------------*/\n/* Steps\n--------------------------*/\n/* Menu\n--------------------------*/\n/* Rate\n--------------------------*/\n/* DatePicker\n--------------------------*/\n/* Loading\n--------------------------*/\n/* Scrollbar\n--------------------------*/\n/* Carousel\n--------------------------*/\n/* Collapse\n--------------------------*/\n/* Transfer\n--------------------------*/\n/* Header\n  --------------------------*/\n/* Footer\n--------------------------*/\n/* Main\n--------------------------*/\n/* Timeline\n--------------------------*/\n/* Backtop\n--------------------------*/\n/* Link\n--------------------------*/\n/* Calendar\n--------------------------*/\n/* Form\n-------------------------- */\n/* Avatar\n--------------------------*/\n/* Break-point\n--------------------------*/\n/* Break-points\n -------------------------- */\n/* Scrollbar\n -------------------------- */\n/* Placeholder\n -------------------------- */\n/* BEM\n -------------------------- */\n._overlay_1dgza_123 {\n  position: fixed;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  background-color: rgba(71, 69, 84, 0.75);\n  z-index: 1000;\n}\n._consent-dialog_1dgza_136 {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  min-width: 500px;\n  max-width: 70%;\n  padding: var(--spacing--lg);\n  background-color: var(--color--background--light-3);\n  border: var(--border);\n  border-radius: var(--radius--lg);\n}\n._header_1dgza_149 {\n  display: flex;\n  align-items: center;\n  gap: var(--spacing--xs);\n}\n._logo_1dgza_155 {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: var(--spacing--2xl);\n  height: var(--spacing--2xl);\n  border: var(--border);\n  border-radius: var(--radius);\n}\n._logo_1dgza_155._n8n_1dgza_164 > div {\n  position: relative;\n  bottom: var(--spacing--5xs);\n}\n._content_1dgza_169 {\n  padding: var(--spacing--lg);\n  display: flex;\n  flex-direction: column;\n  gap: var(--spacing--sm);\n}\n._text-content_1dgza_176 {\n  display: flex;\n  flex-direction: column;\n  gap: var(--spacing--sm);\n}\n._permission-list_1dgza_182 {\n  display: flex;\n  flex-direction: column;\n  gap: var(--spacing--2xs);\n  padding-left: var(--spacing--lg);\n  list-style-type: disc;\n}\n._permission-list_1dgza_182 li {\n  color: var(--color--text);\n  font-size: var(--font-size--2xs);\n}\n._docs-link_1dgza_194 {\n  color: var(--color--text);\n  font-size: var(--font-size--2xs);\n}\n._footer_1dgza_199 {\n  width: 100%;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  gap: var(--spacing--sm);\n}\n._footer_1dgza_199 .notice {\n  margin: 0;\n}\n._footer_1dgza_199 ._button-group_1dgza_209 {\n  display: flex;\n  justify-content: center;\n  gap: var(--spacing--2xs);\n}/*$vite$:1*/";
          ...
          setup(__props) {
            ...
            return (_ctx, _cache) => {
              ...
              return openBlock(), createElementBlock("div", {
                ...
                size: "xlarge",
                color: "text-dark"
              }, null, 8, ["icon"])], 2)], 2), createBaseVNode("div", {
                ...
                _: 1
              }, 8, ["loading", "disabled"])], 2)], 2)], 2)], 2);
            };
          }
        }); //#endregion
        //#region src/app/views/OAuthConsentView.vue?vue&type=style&index=0&lang.module.scss
        overlay = "_overlay_1dgza_123";
        header = "_header_1dgza_149";
        logo = "_logo_1dgza_155";
        n8n = "_n8n_1dgza_164";
        content = "_content_1dgza_169";
        footer = "_footer_1dgza_199";
        OAuthConsentView_vue_vue_type_style_index_0_lang_module_default = {
          overlay,
          "consent-dialog": "_consent-dialog_1dgza_136",
          header,
          logo,
          n8n,
          content,
          "text-content": "_text-content_1dgza_176",
          "permission-list": "_permission-list_1dgza_182",
          "docs-link": "_docs-link_1dgza_194",
          footer,
          "button-group": "_button-group_1dgza_209"
        }; //#endregion
