const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-B-c21ML8.js","assets/index-lSzoI3Qq.js","assets/index-B7wrqKiF.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-B3iKTSYJ.js","assets/chartjs.utils-BKQ1MvPh.js","assets/InsightsSummary-BhEh_hZD.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-DCPOV7gT.js","assets/InsightsChartFailed-CQYBgoBv.js","assets/InsightsChartFailureRate-mac-Hepf.js","assets/InsightsChartTimeSaved-wryRn11t.js","assets/InsightsChartAverageRuntime-DQCm9QLQ.js","assets/InsightsTableWorkflows-jc0UIMUj.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, ek as useModel, gf as useInsightsStore, gp as getTimeRangeLabels, r as ref, h7 as UNLICENSED_TIME_RANGE, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, ed as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, ec as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, h8 as ElDialog, aB as usePageRedirectionHelper, _ as _export_sfc, a3 as useRoute, h9 as INSIGHT_TYPES, dx as defineAsyncComponent, a8 as watch, o as onMounted, ay as useDocumentTitle, m as N8nHeading, n as normalizeClass, dN as _sfc_main$4, c5 as resolveDynamicComponent, aV as __vitePreload, am as useTelemetry, ha as TELEMETRY_TIME_RANGE } from "./index-lSzoI3Qq.js";
import { I as InsightsSummary } from "./InsightsSummary-BhEh_hZD.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-B-c21ML8.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-B3iKTSYJ.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-CQYBgoBv.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-mac-Hepf.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-wryRn11t.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-DQCm9QLQ.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-jc0UIMUj.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
