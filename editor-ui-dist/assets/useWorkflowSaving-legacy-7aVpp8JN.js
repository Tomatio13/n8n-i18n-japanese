;
(function () {
  System.register(["./_MapCache-legacy-CVC6di38.js", "./useMessage-legacy-C-89O3Lx.js", "./useTelemetry-legacy-DyFWt8gD.js", "./useToast-legacy-CQPpmrHA.js", "./constants-legacy-DAaX1J_j.js", "./useExternalHooks-legacy-BUVgQPZx.js", "./npsSurvey.store-legacy-DPD0hCEY.js", "./templates.store-legacy-zNEPhMRK.js", "./focusPanel.store-legacy-DJ_VuJLl.js"], function (_export, _context) {
    "use strict";

    var useI18n, useMessage, tryToParseNumber, useSourceControlStore, useUIStore, injectWorkflowState, useCanvasStore, useWorkflowHelpers, useWorkflowsStore, useNodeTypesStore, useTelemetry, useNodeHelpers, useToast, MODAL_CLOSE, MODAL_CONFIRM, MODAL_CANCEL, VIEWS, NON_ACTIVATABLE_TRIGGER_NODE_TYPES, PLACEHOLDER_EMPTY_WORKFLOW_ID, useExternalHooks, useNpsSurveyStore, useTemplatesStore, useFocusPanelStore;
