;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-8OcfWMWH.js", "./src-legacy-D1xm8eXd.js", "./en-legacy-DJK4SpPN.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-pXf4oSuB.js", "./icon-legacy-JHTpaZZA.js", "./overlay-legacy-CO85mhJY.js", "./empty-legacy-ZG0-xpne.js", "./dialog-legacy-0f7_N5YR.js", "./useTelemetry-legacy-eWIdHYmJ.js", "./useToast-legacy-CzaBlq3A.js", "./sanitize-html-legacy-B93rGWi4.js", "./CalendarDate-legacy-BUvNgcoo.js", "./path-browserify-legacy-PZw06cM9.js", "./constants-legacy-BEJrHPmK.js", "./merge-legacy-UxZ1SIpl.js", "./_baseOrderBy-legacy-B4IaVWF9.js", "./dateformat-legacy-C4HUJTCr.js", "./useDebounce-legacy-B30uWERf.js", "./useExternalHooks-legacy-CEXLoCRJ.js", "./useStyles-legacy-E8NPEyeD.js", "./cloudPlan.store-legacy-G3zBI8_T.js", "./versions.store-legacy-B9b2J4Pf.js", "./usePageRedirectionHelper-legacy-VXtDEenL.js", "./ProjectIcon-legacy-qJiZ5pnu.js", "./orderBy-legacy-xBIT23Z_.js", "./ProjectSharing-legacy-BYdIRTk8.js", "./insights.store-legacy-BEmgieTS.js", "./insights.constants-legacy-CQF1GF20.js", "./insights.utils-legacy-BzNBCZ_d.js", "./smartDecimal-legacy-3qxBuZED.js", "./InsightsSummary-legacy-CvaJxdCZ.js"], function (_export, _context) {
    "use strict";
    ...
    return {
      ...
      execute: function () {
        ...
        InsightsDashboard_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            const InsightsPaywall = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsPaywall-legacy-8NQvWU_1.js"), true               ? void 0 : void 0));
            const InsightsChartTotal = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartTotal-legacy-CQPzjUEd.js"), true               ? void 0 : void 0));
            const InsightsChartFailed = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartFailed-legacy-Dh3hpODZ.js"), true               ? void 0 : void 0));
            const InsightsChartFailureRate = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartFailureRate-legacy-Xmt70AuH.js"), true               ? void 0 : void 0));
            const InsightsChartTimeSaved = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartTimeSaved-legacy-BMTMBKTz.js"), true               ? void 0 : void 0));
            const InsightsChartAverageRuntime = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartAverageRuntime-legacy-Dagr-9Ot.js"), true               ? void 0 : void 0));
            const InsightsTableWorkflows = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsTableWorkflows-legacy-CXoo85A5.js"), true               ? void 0 : void 0));
            const props = __props;
