;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./useTelemetry-legacy-DyFWt8gD.js", "./useToast-legacy-CQPpmrHA.js", "./constants-legacy-DAaX1J_j.js"], function (_export, _context) {
    "use strict";

    var computed, ref, useSettingsStore, useUIStore, STORES, getNextVersions, getWhatsNewSection, useRootStore, defineStore, useUsersStore, useTelemetry, useStorage, useToast, LOCAL_STORAGE_DISMISSED_WHATS_NEW_CALLOUT, VERSIONS_MODAL_KEY, jsonParse, WHATS_NEW_MODAL_KEY, LOCAL_STORAGE_READ_WHATS_NEW_ARTICLES, SEMVER_REGEX, useVersionsStore;
    return {
