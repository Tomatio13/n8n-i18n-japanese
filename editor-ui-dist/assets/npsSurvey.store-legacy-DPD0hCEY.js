...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./useTelemetry-legacy-DyFWt8gD.js", "./constants-legacy-DAaX1J_j.js"], function (_export, _context) {
    ...
    var ref, useSettingsStore, useUIStore, useRootStore, defineStore, getPromptsData, assert, updateNpsSurveyState, NPS_SURVEY_MODAL_KEY, THREE_DAYS_IN_MILLIS, SEVEN_DAYS_IN_MILLIS, CONTACT_PROMPT_MODAL_KEY, SIX_MONTHS_IN_MILLIS, MAXIMUM_TIMES_TO_SHOW_SURVEY_IF_IGNORED, useNpsSurveyStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        getPromptsData = _useTelemetryLegacy00FJs.fs;
        assert = _useTelemetryLegacy00FJs.gc;
        updateNpsSurveyState = _useTelemetryLegacy00FJs.gs;
      }, function (_constantsLegacy00NJs) {
        NPS_SURVEY_MODAL_KEY = _constantsLegacy00NJs.Io;
        THREE_DAYS_IN_MILLIS = _constantsLegacy00NJs.Js;
        SEVEN_DAYS_IN_MILLIS = _constantsLegacy00NJs.Ks;
        CONTACT_PROMPT_MODAL_KEY = _constantsLegacy00NJs.bo;
        SIX_MONTHS_IN_MILLIS = _constantsLegacy00NJs.qs;
      }],
      execute: function () {
