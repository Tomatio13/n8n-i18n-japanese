;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./useTelemetry-legacy-DyFWt8gD.js", "./constants-legacy-DAaX1J_j.js"], function (_export, _context) {
    "use strict";

    var computed, reactive, useSettingsStore, getExternalSecrets, testExternalSecretsProviderConnection, reloadProvider, updateProvider, useRBACStore, connectProvider, getExternalSecretsProviders, useRootStore, defineStore, getExternalSecretsProvider, EnterpriseEditionFeature, useExternalSecretsStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        getExternalSecrets = _useTelemetryLegacy00FJs.Cs;
        testExternalSecretsProviderConnection = _useTelemetryLegacy00FJs.Ds;
        reloadProvider = _useTelemetryLegacy00FJs.Es;
        updateProvider = _useTelemetryLegacy00FJs.Os;
        useRBACStore = _useTelemetryLegacy00FJs.Qn;
        connectProvider = _useTelemetryLegacy00FJs.Ss;
        getExternalSecretsProviders = _useTelemetryLegacy00FJs.Ts;
        useRootStore = _useTelemetryLegacy00FJs.Zs;
        defineStore = _useTelemetryLegacy00FJs.bc;
        getExternalSecretsProvider = _useTelemetryLegacy00FJs.ws;
