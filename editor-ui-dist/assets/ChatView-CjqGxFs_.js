const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-Btu-KMHS.js","assets/core-tTLzQqla.js","assets/chunk-r2Y0G7H8.js","assets/languageModules-CLlfIxAj.js","assets/xml-cG-Wv7SS.js"])))=>i.map(i=>d[i]);
...
import { D as useElementSize, F as useScroll, L as useSpeechRecognition, M as useLocalStorage, N as useMediaQuery, R as useSpeechSynthesis, vt as useI18n, yt as I18nT } from "./_MapCache-CLd8BZI_.js";
...
import { v as useRoute, y as useRouter } from "./truncate-1b_i1toh.js";
import { Dr as v4_default, an as useDocumentTitle, br as useToast, ls as useSettingsStore, r as useUIStore, s as useWorkflowsStore, t as useUsersStore } from "./users.store-CJpDpt5e.js";
import "./sanitize-html-DeDnsMgc.js";
import "./empty-nq5-pHAR.js";
import { Ds as LOCAL_STORAGE_CHAT_HUB_SELECTED_TOOLS, Es as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL, Jr as PROVIDER_CREDENTIAL_TYPE_MAP, Xr as chatHubConversationModelSchema, fi as INodesSchema, zo as VIEWS } from "./constants-D3cVjlue.js";
...
import "./CredentialIcon-DX5wEdPQ.js";
import { t as VueMarkdown_default } from "./VueMarkdown-Be_kjZhF.js";
import "./NodeIcon-MOqC9ZrS.js";
import { g as MOBILE_MEDIA_QUERY, n as CHAT_CONVERSATION_VIEW, t as AGENT_EDITOR_MODAL_KEY, u as CHAT_VIEW, v as TOOLS_SELECTOR_MODAL_KEY, y as providerDisplayNames } from "./constants-BbdtyW6i.js";
import { _ as buildChatAttachmentUrl, a as findOneFromModelsResponse, d as isLlmProvider, f as isLlmProviderModel, h as unflattenModel, r as createMimeTypes, t as useChatStore } from "./chat.store-Bb89kMIN.js";
import { n as ToolsSelector_default, r as ModelSelector_default, t as useCustomAgent } from "./useCustomAgent-Cl7t3mL0.js";
import { t as ChatAgentAvatar_default } from "./ChatAgentAvatar-Dlq4A9h6.js";
import { n as useChatCredentials, r as chatHubConversationModelWithCachedDisplayNameSchema, t as ChatLayout_default } from "./ChatLayout-CjrKwz-C.js";
import { t as ChatFile_default } from "./ChatFile-BJXcjtPD.js";
...
function useChatHubMarkdownOptions(codeBlockActionsClassName, tableContainerClassName) {
	...
	async function loadLanguageModules() {
		...
		try {
			asyncImport = {
				status: "inProgress",
				promise: Promise.all([__vitePreload(() => import("./es-Btu-KMHS.js"), __vite__mapDeps([0,1,2])), __vitePreload(() => import("./languageModules-CLlfIxAj.js"), __vite__mapDeps([3,4]))])
			};
