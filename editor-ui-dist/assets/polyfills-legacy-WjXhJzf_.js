(function() {
	...
	var require_function_uncurry_this_accessor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(object, key$1, method) {
			try {
				return uncurryThis$14(aCallable$4(Object.getOwnPropertyDescriptor(object, key$1)[method]));
			} catch (error) {}
		};
	}));
	...
	var require_error_stack_clear = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var $Error$1 = Error;
		var replace = uncurryThis$10("".replace);
	...
	var descriptor$2 = NativeDOMException && DESCRIPTORS$1 && Object.getOwnPropertyDescriptor(globalThis$25, DOM_EXCEPTION);
	...
	var require_regexp_flags_detection = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var RegExp$1 = globalThis$24.RegExp;
	...
	var require_environment = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = (function() {
			...
			if (globalThis$23.Bun && typeof Bun.version == "string") return "BUN";
			if (globalThis$23.Deno && typeof Deno.version == "object") return "DENO";
			if (classof$5(globalThis$23.process) === "process") return "NODE";
			if (globalThis$23.window && globalThis$23.document) return "BROWSER";
			return "REST";
		})();
	}));
	...
	var require_get_built_in_node_module = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(name) {
			if (IS_NODE$1) {
				try {
					return globalThis$22.process.getBuiltinModule(name);
				} catch (error) {}
				try {
	...
	var require_detach_transferable = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var $ArrayBuffer = globalThis$20.ArrayBuffer;
		var $MessageChannel = globalThis$20.MessageChannel;
		var detach = false;
	...
	var Object$1 = globalThis$19.Object;
	var Array$1 = globalThis$19.Array;
	var Date = globalThis$19.Date;
	var Error$1 = globalThis$19.Error;
	var TypeError$4 = globalThis$19.TypeError;
	var PerformanceMark = globalThis$19.PerformanceMark;
	...
	var thisBooleanValue = uncurryThis$7(true.valueOf);
	var thisNumberValue = uncurryThis$7(1.1.valueOf);
	var thisStringValue = uncurryThis$7("".valueOf);
	...
	var checkBasicSemantic = function(structuredCloneImplementation) {
		return !fails$2(function() {
			var set1 = new globalThis$19.Set([7]);
	...
	var checkNewErrorsCloningSemantic = function(structuredCloneImplementation) {
		return !fails$2(function() {
			var test$1 = structuredCloneImplementation(new globalThis$19.AggregateError([1], PERFORMANCE_MARK, { cause: 3 }));
			return test$1.name !== "AggregateError" || test$1.errors[0] !== 1 || test$1.message !== PERFORMANCE_MARK || test$1.cause !== 3;
		});
	};
	var nativeStructuredClone = globalThis$19.structuredClone;
	...
	var createDataTransfer = function() {
		var dataTransfer;
		try {
			dataTransfer = new globalThis$19.DataTransfer();
		} catch (error) {
			try {
				dataTransfer = new globalThis$19.ClipboardEvent("").clipboardData;
			} catch (error2) {}
		}
	...
	var cloneBuffer = function(value, map, $type) {
		...
		if (type === "SharedArrayBuffer") if (nativeRestrictedStructuredClone) clone$3 = nativeRestrictedStructuredClone(value);
			...
			if (!DataView$2 && !isCallable$4(value.slice)) throwUnpolyfillable("ArrayBuffer");
			try {
	...
	var tryToTransfer = function(rawTransfer, map) {
		...
		while (i < length) {
			...
			if (PROPER_STRUCTURED_CLONE_TRANSFER) transferred = nativeStructuredClone(value, { transfer: [value] });
				...
				case "ImageBitmap":
					C = globalThis$19.OffscreenCanvas;
	...
	var require_array_buffer_view_core = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		var Int8Array$1 = globalThis$18.Int8Array;
		var Int8ArrayPrototype = Int8Array$1 && Int8Array$1.prototype;
		var Uint8ClampedArray = globalThis$18.Uint8ClampedArray;
		...
		var NATIVE_ARRAY_BUFFER_VIEWS = NATIVE_ARRAY_BUFFER$1 && !!setPrototypeOf$1 && classof$3(globalThis$18.opera) !== "Opera";
		...
		var exportTypedArrayMethod$1 = function(KEY, property, forced, options) {
			...
			if (forced) for (var ARRAY in TypedArrayConstructorsList) {
				var TypedArrayConstructor = globalThis$18[ARRAY];
		...
		var exportTypedArrayStaticMethod = function(KEY, property, forced) {
			...
			if (setPrototypeOf$1) {
				if (forced) for (ARRAY in TypedArrayConstructorsList) {
					TypedArrayConstructor = globalThis$18[ARRAY];
		...
		for (NAME in TypedArrayConstructorsList) {
			Constructor = globalThis$18[NAME];
		...
		if (!NATIVE_ARRAY_BUFFER_VIEWS || !isCallable$3(TypedArray) || TypedArray === Function.prototype) {
			...
			if (NATIVE_ARRAY_BUFFER_VIEWS) {
				for (NAME in TypedArrayConstructorsList) if (globalThis$18[NAME]) setPrototypeOf$1(globalThis$18[NAME], TypedArray);
			}
		}
		if (!NATIVE_ARRAY_BUFFER_VIEWS || !TypedArrayPrototype || TypedArrayPrototype === ObjectPrototype) {
			TypedArrayPrototype = TypedArray.prototype;
			if (NATIVE_ARRAY_BUFFER_VIEWS) {
				for (NAME in TypedArrayConstructorsList) if (globalThis$18[NAME]) setPrototypeOf$1(globalThis$18[NAME].prototype, TypedArrayPrototype);
			}
		}
		...
		if (DESCRIPTORS && !hasOwn$5(TypedArrayPrototype, TO_STRING_TAG$1)) {
			...
			for (NAME in TypedArrayConstructorsList) if (globalThis$18[NAME]) createNonEnumerableProperty$2(globalThis$18[NAME], TYPED_ARRAY_TAG, NAME);
		}
		module.exports = {
