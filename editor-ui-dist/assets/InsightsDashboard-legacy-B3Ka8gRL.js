;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-jSgIbBtY.js", "./src-legacy-DFXX477B.js", "./en-legacy-DJK4SpPN.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-DqBw9src.js", "./icon-legacy-D3Vx_RMG.js", "./overlay-legacy-Cqmg_IhW.js", "./empty-legacy-ZG0-xpne.js", "./dialog-legacy-C-e6CkPa.js", "./useTelemetry-legacy-VnN6Lamb.js", "./useToast-legacy-BOZFiTr3.js", "./sanitize-html-legacy-B93rGWi4.js", "./CalendarDate-legacy-BUvNgcoo.js", "./path-browserify-legacy-PZw06cM9.js", "./constants-legacy-CUFnuZt5.js", "./merge-legacy-CO1t_HoR.js", "./_baseOrderBy-legacy-_y5jgHlf.js", "./dateformat-legacy-C4HUJTCr.js", "./useDebounce-legacy-CiLy_wez.js", "./useExternalHooks-legacy-jTw46bwX.js", "./useStyles-legacy-E8NPEyeD.js", "./cloudPlan.store-legacy-DOD6H4k1.js", "./versions.store-legacy-BgalgEH5.js", "./usePageRedirectionHelper-legacy-C7MLsOIe.js", "./ProjectIcon-legacy-S4brGHCT.js", "./orderBy-legacy-BJZuhqwZ.js", "./ProjectSharing-legacy-cxhG5LQh.js", "./insights.store-legacy-BKkRiWeu.js", "./insights.constants-legacy-CQF1GF20.js", "./insights.utils-legacy-CEExVWIy.js", "./smartDecimal-legacy-DXLRFaT7.js", "./InsightsSummary-legacy-Bl3ZNFS9.js"], function (_export, _context) {
    "use strict";
    ...
    return {
      ...
      execute: function () {
        ...
        InsightsDashboard_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            const InsightsPaywall = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsPaywall-legacy-iy-xDwjR.js"), true               ? void 0 : void 0));
            const InsightsChartTotal = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartTotal-legacy-4lmp4gS6.js"), true               ? void 0 : void 0));
            const InsightsChartFailed = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartFailed-legacy-DmDWZfMM.js"), true               ? void 0 : void 0));
            const InsightsChartFailureRate = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartFailureRate-legacy-OqlAMdJl.js"), true               ? void 0 : void 0));
            const InsightsChartTimeSaved = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartTimeSaved-legacy-CkbbSDEm.js"), true               ? void 0 : void 0));
            const InsightsChartAverageRuntime = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsChartAverageRuntime-legacy-6Zgwllip.js"), true               ? void 0 : void 0));
            const InsightsTableWorkflows = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./InsightsTableWorkflows-legacy-BqxcGSZf.js"), true               ? void 0 : void 0));
            const props = __props;
