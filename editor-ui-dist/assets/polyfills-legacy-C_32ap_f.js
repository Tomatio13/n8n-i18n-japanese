(function() {
	...
	if (PolyfilledDOMExceptionPrototype.constructor !== PolyfilledDOMException) {
		...
		for (var key in DOMExceptionConstants) if (hasOwn$7(DOMExceptionConstants, key)) {
			...
			if (!hasOwn$7(PolyfilledDOMException, constantName)) defineProperty$3(PolyfilledDOMException, constantName, createPropertyDescriptor$2(6, constant.c));
		}
	}
