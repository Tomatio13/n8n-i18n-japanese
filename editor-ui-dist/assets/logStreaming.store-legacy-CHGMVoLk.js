...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./useTelemetry-legacy-DyFWt8gD.js"], function (_export, _context) {
    ...
    var ref, getDestinationsFromBackend, hasDestinationId, saveDestinationToDb, sendTestMessageToDestination, useRootStore, defineStore, getEventNamesFromBackend, deleteDestinationFromDb, eventGroupFromEventName, prettifyEventName, eventGroupsFromStringList, useLogStreamingStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ref = _vueRuntimeEsmBundlerLegacy003Js.It;
      }, function (_useTelemetryLegacy00FJs) {
        getDestinationsFromBackend = _useTelemetryLegacy00FJs.As;
        hasDestinationId = _useTelemetryLegacy00FJs.Ms;
        saveDestinationToDb = _useTelemetryLegacy00FJs.Ns;
        sendTestMessageToDestination = _useTelemetryLegacy00FJs.Ps;
        useRootStore = _useTelemetryLegacy00FJs.Zs;
        defineStore = _useTelemetryLegacy00FJs.bc;
        getEventNamesFromBackend = _useTelemetryLegacy00FJs.js;
        deleteDestinationFromDb = _useTelemetryLegacy00FJs.ks;
      }],
      execute: function () {
