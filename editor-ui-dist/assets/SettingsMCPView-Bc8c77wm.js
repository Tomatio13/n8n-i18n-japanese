...
import { Tn as useDocumentTitle, Zs as useRootStore, er as useUsersStore, o as useWorkflowsStore } from "./useTelemetry-Bj7xGk8p.js";
import { t as useToast } from "./useToast-DELebJfp.js";
import "./sanitize-html-Cfxibw1n.js";
import "./path-browserify-CTmc1OxV.js";
import { mo as VIEWS } from "./constants-WMddrDmV.js";
...
import "./banners.store-BJqfM2wK.js";
...
import "./roles.store-CdNG8yQC.js";
import "./sso.store-DLstg5Cy.js";
import { t as router_default } from "./router-D1cykibD.js";
import "./insights.store-C-vNCXdZ.js";
...
import "./useRecentResources-BEV_flTE.js";
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass(_ctx.$style["workflow-table-container"]) }, [props.loading ? (openBlock(), createElementBlock("div", _hoisted_1, [createVNode(unref(N8nLoading_default), {
				...
				[`item.name`]: withCtx(({ item: item$2 }) => [createVNode(unref(N8nLink_default), {
					"new-window": true,
				...
				[`item.parentFolder`]: withCtx(({ item: item$2 }) => [item$2.parentFolder ? (openBlock(), createElementBlock("span", {
					key: 0,
				...
				[`item.homeProject`]: withCtx(({ item: item$2 }) => [item$2.homeProject ? (openBlock(), createElementBlock("span", {
					key: 0,
					class: normalizeClass(_ctx.$style["folder-cell"])
...
const header = "_header_1ey1l_127";
