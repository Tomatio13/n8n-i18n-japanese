(function() {
	...
	var require_get_iterator_flattenable = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(obj, stringHandling) {
			...
			return getIteratorDirect$5(anObject$7(method !== void 0 ? call$7(method, obj) : obj));
		};
	}));
	...
	var IteratorProxy$1 = createIteratorProxy$1(function() {
		...
		while (true) {
			if (inner = this.inner) try {
				result = anObject$6(call$6(inner.next, inner.iterator));
				if (!result.done) return result.value;
				this.inner = null;
			} catch (error) {
				iteratorClose$3(iterator, "throw", error);
			}
			result = anObject$6(call$6(this.next, iterator));
	...
	var require_regexp_get_flags = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = regExpFlagsDetection.correct ? function(it) {
			...
			return !regExpFlagsDetection.correct && isPrototypeOf$2(RegExpPrototype, it) && !hasOwn$7(it, "flags") ? call$4(regExpFlagsGetterImplementation, it) : it.flags;
		};
	}));
	...
	var tryToTransfer = function(rawTransfer, map) {
		...
		var transfer = [];
		iterate$2(rawTransfer, function(value$1) {
			push$2(transfer, anObject$3(value$1));
		});
		var i = 0;
	...
	$$12({
		...
		var options = validateArgumentsLength$4(arguments.length, 1) > 1 && !isNullOrUndefined(arguments[1]) ? anObject$3(arguments[1]) : void 0;
