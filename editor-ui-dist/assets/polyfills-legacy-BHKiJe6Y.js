(function() {
	...
	var IteratorProxy$2 = createIteratorProxy$2(function() {
		var iterator = this.iterator;
		var result = anObject$13(call$15(this.next, iterator));
	...
	$$28({
		...
		if (mapWithoutClosingOnEarlyError) return call$15(mapWithoutClosingOnEarlyError, this, mapper);
	...
	$$27({
		...
		return new IteratorProxy$1(getIteratorDirect$8(this), { predicate });
	} });
