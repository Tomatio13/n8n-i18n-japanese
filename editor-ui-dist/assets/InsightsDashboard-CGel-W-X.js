const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-yUXGcI0h.js","assets/index-DTeglzKi.js","assets/index-Am8RmnT4.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-B6v3W_7C.js","assets/chartjs.utils-CBCRu9mz.js","assets/InsightsSummary-n7-dF2Vf.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-u4vWXu_A.js","assets/InsightsChartFailed-DK9fP4h5.js","assets/InsightsChartFailureRate-C007C7ZP.js","assets/InsightsChartTimeSaved-BeW3TewP.js","assets/InsightsChartAverageRuntime-CHi-wuOI.js","assets/InsightsTableWorkflows-D8T2ivAi.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, e9 as useModel, g2 as useInsightsStore, r as ref, gL as UNLICENSED_TIME_RANGE, gc as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, e2 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, e1 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, gM as ElDialog, aA as usePageRedirectionHelper, _ as _export_sfc, a2 as useRoute, gN as INSIGHT_TYPES, dl as defineAsyncComponent, a7 as watch, o as onMounted, ax as useDocumentTitle, m as N8nHeading, n as normalizeClass, dC as _sfc_main$4, c3 as resolveDynamicComponent, aU as __vitePreload, al as useTelemetry, gO as TELEMETRY_TIME_RANGE } from "./index-DTeglzKi.js";
import { I as InsightsSummary } from "./InsightsSummary-n7-dF2Vf.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-yUXGcI0h.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-B6v3W_7C.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-DK9fP4h5.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-C007C7ZP.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-BeW3TewP.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-CHi-wuOI.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-D8T2ivAi.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
