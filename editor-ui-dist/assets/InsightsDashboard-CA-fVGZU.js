const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-B4lPcaSE.js","assets/index-xrDj6cyN.js","assets/index-COleXxZf.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-0SAIzbl7.js","assets/chartjs.utils-Dk8i3yoS.js","assets/InsightsSummary-CJmhpg7w.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-Brx0sD4b.js","assets/InsightsChartFailed-CE8QeW78.js","assets/InsightsChartFailureRate-BeIhRxjo.js","assets/InsightsChartTimeSaved-B38g_1uR.js","assets/InsightsChartAverageRuntime-DcG67GYI.js","assets/InsightsTableWorkflows--QEE09v9.js","assets/N8nDataTableServer-B_tdr0lm.js","assets/InsightsTableWorkflows-DJhX6bQW.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, cU as useModel, hj as useInsightsStore, r as ref, hz as UNLICENSED_TIME_RANGE, hn as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, y as renderList, l as unref, f2 as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, f1 as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hA as ElDialog, al as usePageRedirectionHelper, _ as _export_sfc, et as defineAsyncComponent, aa as watch, o as onMounted, ai as useDocumentTitle, m as N8nHeading, n as normalizeClass, eE as _sfc_main$4, b_ as resolveDynamicComponent, ay as useTelemetry, hB as TELEMETRY_TIME_RANGE, aI as __vitePreload } from "./index-xrDj6cyN.js";
import { I as InsightsSummary } from "./InsightsSummary-CJmhpg7w.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-B4lPcaSE.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-0SAIzbl7.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-CE8QeW78.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-BeIhRxjo.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-B38g_1uR.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-DcG67GYI.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows--QEE09v9.js"), true ? __vite__mapDeps([13,1,2,14,6,7,15]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
