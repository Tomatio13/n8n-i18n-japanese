...
import { D as useElementSize, G as isClient, J as noop, K as isIOS, P as useResizeObserver, W as directiveHooks, Y as notNullish, bt as useI18n, dt as isVue2, et as toRef, g as onClickOutside, h as computedAsync, it as tryOnScopeDispose, nt as toValue$1, ot as useDebounceFn, q as isObject, rt as tryOnMounted, st as useThrottleFn, xt as I18nT } from "./_MapCache-74QeOTmX.js";
...
import { C as useNodeTypesStore, Ht as ProjectTypes, It as useNDVStore, Lt as injectWorkflowState, Mt as useNodeHelpers, Nt as useTelemetry, R as removePreviewToken, Tt as useWorkflowHelpers, _r as useExternalHooks, di as RenameNodeCommand, fs as useSettingsStore, ha as COMMUNITY_NODES_INSTALLATION_DOCS_URL, hr as useToast, ni as useHistoryStore, oa as importCurlEventBus, r as useUIStore, rt as useCredentialsStore, s as useWorkflowsStore, t as useUsersStore, va as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, w as useActionsGenerator } from "./users.store-CrI_QF4Z.js";
import { A as TitledList_default, O as NodeCredentials_default, d as useNodeSettingsParameters, f as collectParametersByTab, g as getNodeSettingsInitialValues, k as useNodeCredentialOptions, m as createCommonNodeSettings, p as collectSettings, t as ParameterInputList_default, y as nameIsParameter } from "./ParameterInputList-DQhzRoPW.js";
import { n as ElRow, t as ElCol } from "./col-CiX-xcE_.js";
import { $a as NodeConnectionTypes, F as CUSTOM_API_CALL_KEY, Fa as isCommunityPackageName, Kn as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, Pa as deepCopy, Qt as DATA_TABLE_NODES, Ut as CHAT_TRIGGER_NODE_TYPE, Xo as VIEWS, Yn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, b as NPM_PACKAGE_DOCS_BASE_URL, bo as OPEN_AI_API_CREDENTIAL_TYPE, d as CUSTOM_NODES_DOCS_URL, ia as getNodeInputs, jn as MCP_TRIGGER_NODE_TYPE, l as BUILTIN_NODES_DOCS_URL, mn as FORM_TRIGGER_NODE_TYPE, oa as getNodeParameters, s as BASE_NODE_SURVEY_URL } from "./constants-DW-GgiaW.js";
import { t as useDebounce } from "./useDebounce-BO8y4IzP.js";
...
import { a as useInstallNode, i as useInstalledCommunityPackage, n as CommunityNodeFooter_default, r as ContactAdministratorToInstall_default, t as CommunityNodeUpdateInfo_default } from "./CommunityNodeUpdateInfo-BdjE4V1a.js";
...
import { t as useActions } from "./useActions-BJrETOnj.js";
