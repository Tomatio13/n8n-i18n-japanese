const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-BlWtL2eU.js","assets/index-CqaLBXXR.js","assets/index-CpPc1kM8.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-CRwdTzLh.js","assets/chartjs.utils-DjcgRh2r.js","assets/InsightsSummary-DnGUCnw-.js","assets/InsightsSummary-DTFIhBF3.css","assets/index-D_U2EoAy.js","assets/InsightsChartFailed-w-Q9sG2j.js","assets/InsightsChartFailureRate-CDNuBqeZ.js","assets/InsightsChartTimeSaved-C2MycRoT.js","assets/InsightsChartAverageRuntime-BXOkRIOA.js","assets/InsightsTableWorkflows-fCq3Bddy.js","assets/InsightsTableWorkflows-BTHSCwX8.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, em as useModel, gh as useInsightsStore, gr as getTimeRangeLabels, r as ref, hb as UNLICENSED_TIME_RANGE, e as createBlock, g as openBlock, w as withCtx, h as createElementBlock, F as Fragment, A as renderList, l as unref, ed as _sfc_main$3, k as createTextVNode, f as createCommentVNode, t as toDisplayString, j as createBaseVNode, ec as N8nSelect, x as computed, c as useI18n, i as createVNode, p as N8nText, q as N8nButton, hc as ElDialog, aB as usePageRedirectionHelper, _ as _export_sfc, a3 as useRoute, av as useProjectsStore, hd as INSIGHT_TYPES, dx as defineAsyncComponent, a8 as watch, o as onMounted, ay as useDocumentTitle, b2 as onBeforeMount, m as N8nHeading, n as normalizeClass, fI as ProjectSharing, dN as _sfc_main$4, c5 as resolveDynamicComponent, aV as __vitePreload, am as useTelemetry, he as TELEMETRY_TIME_RANGE } from "./index-CqaLBXXR.js";
import { I as InsightsSummary } from "./InsightsSummary-DnGUCnw-.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-BlWtL2eU.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-CRwdTzLh.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-w-Q9sG2j.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-CDNuBqeZ.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-C2MycRoT.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-BXOkRIOA.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-fCq3Bddy.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
