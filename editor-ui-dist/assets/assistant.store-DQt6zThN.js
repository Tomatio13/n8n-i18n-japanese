...
import { _t as isToolMessage, vt as isWorkflowUpdatedMessage } from "./src-BVivsRgW.js";
import { x as createEventBus, y as useRoute } from "./truncate-Ck6UaU_n.js";
import { Bo as useSettingsStore, Ht as useCredentialsStore, Jt as getSessionsMetadata, Kr as getAuthTypeForNodeCredential, Kt as getAiSessions, Ni as useUIStore, Sn as injectWorkflowState, To as CREDENTIAL_EDIT_MODAL_KEY, Ut as chatWithAssistant, Wt as chatWithBuilder, Xt as useAIAssistantHelpers, Yt as replaceCode, a as useNDVStore, ac as STORES, er as useUsersStore, ji as codeNodeEditorEventBus, o as useWorkflowsStore, qr as getMainAuthField, qt as getBuilderCredits, rt as useNodeTypesStore, t as useTelemetry, xi as stringSizeInBytes } from "./useTelemetry-BeI6sUZT.js";
import { t as useToast } from "./useToast-BoMuAjRw.js";
import { Dr as require_pick, Eo as EDITABLE_CANVAS_VIEWS, Oo as VIEWS, Xi as jsonParse, qi as deepCopy, s as PLACEHOLDER_EMPTY_WORKFLOW_ID, t as DEFAULT_NEW_WORKFLOW_NAME } from "./constants-pWZn2DpD.js";
import { D as defineStore, m as assert, t as useRootStore } from "./useRootStore-Ab0OGVtg.js";
