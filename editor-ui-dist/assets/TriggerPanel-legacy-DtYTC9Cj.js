;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-CVC6di38.js", "./src-legacy-DaU7H7T8.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-BWR_lVFz.js", "./useTelemetry-legacy-DyFWt8gD.js", "./constants-legacy-DAaX1J_j.js", "./useRunWorkflow-legacy-DYbEugng.js", "./usePinnedData-legacy-B0pER9c6.js", "./nodeCreator.store-legacy-DcRZzhNx.js", "./NodeIcon-legacy-DKkXHEXu.js", "./CopyInput-legacy-CaW3Tila.js", "./isEmpty-legacy-D6OerWum.js", "./NDVEmptyState-legacy-CfVMLVCf.js", "./VirtualSchema-legacy-Bi24oJ6r.js", "./dateFormatter-legacy-9mbvflpR.js", "./useExecutionData-legacy-DN9lGyVF.js", "./useLogsTreeExpand-legacy-wOE4bvSn.js", "./RunDataParsedAiContent-legacy-BhSaspMp.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, createElementBlock, createCommentVNode, unref, ref, onBeforeUnmount, createVNode, defineComponent, toDisplayString, createBlock, onMounted, Fragment, normalizeClass, watch, withCtx, openBlock, renderList, createTextVNode, createSlots, Transition, vShow, resolveDirective, createBaseVNode, withDirectives, shallowRef, I18nT, useI18n, N8nInfoAccordion_default, N8nText_default, N8nButton_default, N8nInfoTip_default, N8nHeading_default, N8nSpinner_default, N8nPulse_default, N8nLink_default, N8nTooltip_default, N8nRadioButtons_default, N8nIcon_default, __plugin_vue_export_helper_default, useRouter, createEventBus, parseAiContent, useUIStore, getTriggerNodeServiceName, injectWorkflowState, formatTokenUsageCount, useNDVStore, usePostHog, useWorkflowHelpers, waitingNodeTooltip, useWorkflowsStore, isTriggerPanelObject, useNodeTypesStore, useTelemetry, storeToRefs, CanvasNodeDirtiness, NDV_UI_OVERHAUL_EXPERIMENT, WEBHOOK_NODE_TYPE, CHAT_TRIGGER_NODE_TYPE, FORM_TRIGGER_NODE_TYPE, NodeConnectionTypes, VIEWS, WORKFLOW_SETTINGS_MODAL_KEY, useNodeDirtiness, useNodeType, usePinnedData, require_capitalize, NodeIcon_default, CopyInput_default, NodeErrorView_default, ViewSubExecution_default, RunData_default, NDVEmptyState_default, NodeExecuteButton_default, convertToDisplayDateComponents, useExecutionData, findLogEntryById, getConsumedTokens, useLogsExecutionData, ConsumedTokensDetails_default, LogsOverviewRows_default, useLogsTreeExpand, getReferencedData, RunDataParsedAiContent_default, __vite_style__, _hoisted_1$3, FloatingNodePosition, NDVFloatingNodes_vue_vue_type_script_setup_true_lang_default, floatingNodes, nodesList, inputSub, outputSub, outputMain, inputMain, connectedNode, v2, NDVFloatingNodes_vue_vue_type_style_index_0_lang_module_default, cssModules$6, NDVFloatingNodes_default, RunInfo_vue_vue_type_script_setup_true_lang_default, tooltipRow, RunInfo_vue_vue_type_style_index_0_lang_module_default, cssModules$5, RunInfo_default, import_capitalize, AiRunContentBlock_vue_vue_type_script_setup_true_lang_default, block, blockContent, blockContentExpanded, rawSwitch, blockHeader, blockTitle, blockToggle, error, AiRunContentBlock_vue_vue_type_style_index_0_lang_module_default, cssModules$4, AiRunContentBlock_default, _hoisted_1$2, _hoisted_2$1, _hoisted_3$1, RunDataAiContent_vue_vue_type_script_setup_true_lang_default, container$2, nodeIcon, header$1, headerWrap, title$1, meta, tokensUsage, RunDataAiContent_vue_vue_type_style_index_0_lang_module_default, cssModules$3, RunDataAiContent_default, RunDataAi_vue_vue_type_script_setup_true_lang_default, noData, empty, tree, runData$1, container$1, RunDataAi_vue_vue_type_style_index_0_lang_module_default, cssModules$2, RunDataAi_default, _hoisted_1$1, OutputPanel_vue_vue_type_script_setup_true_lang_default, runData, runDataV2, outputTypeSelect, titleSection, titleSectionV2, title, titleV2, noOutputData, link, spinner, OutputPanel_vue_vue_type_style_index_0_lang_module_default, cssModules$1, OutputPanel_default, _hoisted_1, _hoisted_2, _hoisted_3, _hoisted_4, _hoisted_5, _hoisted_6, _hoisted_7, _hoisted_8, TriggerPanel_vue_vue_type_script_setup_true_lang_default, container, header, action, shake, accordion, TriggerPanel_vue_vue_type_style_index_0_lang_module_default, cssModules, TriggerPanel_default;
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        storeToRefs = _useTelemetryLegacy00FJs.xc;
        ...
        AiRunContentBlock_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            ...
            return (_ctx, _cache) => {
              ...
              }, null, 8, ["data", "type", "content", "render-type"]))], 2)], 2);
            };
          }
        }); //#endregion
