;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-8OcfWMWH.js", "./truncate-legacy-COQs_hNk.js", "./useTelemetry-legacy-DRbFTEPe.js", "./constants-legacy-BnN5j0Of.js", "./merge-legacy-Bk31cAi2.js", "./_baseOrderBy-legacy-Helkyheh.js", "./useExternalHooks-legacy-cRYXgFRw.js", "./templates.store-legacy-COMhIBM_.js", "./nodeIcon-legacy-6VM1SPil.js"], function (_export, _context) {
    "use strict";
    ...
    */
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        AI_CATEGORY_LANGUAGE_MODELS = _constantsLegacy00VJs.$;
        EDIT_IMAGE_NODE_TYPE = _constantsLegacy00VJs.$t;
        TRANSFORM_DATA_SUBCATEGORY = _constantsLegacy00VJs.At;
        CHAT_TRIGGER_NODE_TYPE = _constantsLegacy00VJs.Bt;
        LIMIT_NODE_TYPE = _constantsLegacy00VJs.Cn;
        NODE_CREATOR_OPEN_SOURCES = _constantsLegacy00VJs.Ct;
        MARKDOWN_NODE_TYPE = _constantsLegacy00VJs.Dn;
        REGULAR_NODE_CREATOR_VIEW = _constantsLegacy00VJs.Dt;
        MANUAL_TRIGGER_NODE_TYPE = _constantsLegacy00VJs.En;
        CODE_NODE_TYPE = _constantsLegacy00VJs.Ht;
        CUSTOM_API_CALL_KEY = _constantsLegacy00VJs.I;
        VIEWS = _constantsLegacy00VJs.Io;
        AI_TRANSFORM_NODE_TYPE$1 = _constantsLegacy00VJs.It;
        CRYPTO_NODE_TYPE = _constantsLegacy00VJs.Jt;
        NodeConnectionTypes = _constantsLegacy00VJs.Ka;
        require__arrayIncludes = _constantsLegacy00VJs.Mi;
        AGGREGATE_NODE_TYPE = _constantsLegacy00VJs.Nt;
        isCommunityPackageName = _constantsLegacy00VJs.Oa;
        AI_CODE_NODE_TYPE = _constantsLegacy00VJs.Pt;
        AI_CATEGORY_EMBEDDING = _constantsLegacy00VJs.Q;
        AI_TRANSFORM_NODE_TYPE = _constantsLegacy00VJs.Qa;
        SCHEDULE_TRIGGER_NODE_TYPE = _constantsLegacy00VJs.Qn;
        require__SetCache = _constantsLegacy00VJs.So;
        HUMAN_IN_THE_LOOP_CATEGORY = _constantsLegacy00VJs.St;
        COMPRESSION_NODE_TYPE = _constantsLegacy00VJs.Ut;
        CONVERT_TO_FILE_NODE_TYPE = _constantsLegacy00VJs.Wt;
        AI_CATEGORY_CHAINS = _constantsLegacy00VJs.X;
        RSS_READ_NODE_TYPE = _constantsLegacy00VJs.Xn;
        DATA_TABLE_NODE_TYPE = _constantsLegacy00VJs.Xt;
        AI_CATEGORY_AGENTS = _constantsLegacy00VJs.Y;
        REMOVE_DUPLICATES_NODE_TYPE = _constantsLegacy00VJs.Yn;
        AI_CATEGORY_DOCUMENT_LOADERS = _constantsLegacy00VJs.Z;
        DATETIME_NODE_TYPE = _constantsLegacy00VJs.Zt;
        IF_NODE_TYPE = _constantsLegacy00VJs._n;
        CORE_NODES_CATEGORY = _constantsLegacy00VJs._t;
        PRE_BUILT_AGENTS_MODAL_KEY = _constantsLegacy00VJs.as;
        AI_CATEGORY_ROOT_NODES = _constantsLegacy00VJs.at;
        HELPERS_SUBCATEGORY = _constantsLegacy00VJs.bt;
        require__baseFlatten = _constantsLegacy00VJs.ci;
        EXTRACT_FROM_FILE_NODE_TYPE = _constantsLegacy00VJs.cn;
        AI_CATEGORY_VECTOR_STORES = _constantsLegacy00VJs.ct;
        FORM_TRIGGER_NODE_TYPE = _constantsLegacy00VJs.dn;
        SUMMARIZE_NODE_TYPE = _constantsLegacy00VJs.dr;
        AI_NODE_CREATOR_VIEW = _constantsLegacy00VJs.dt;
        AI_CATEGORY_MCP_NODES = _constantsLegacy00VJs.et;
        AI_OTHERS_NODE_CREATOR_VIEW = _constantsLegacy00VJs.ft;
        HTTP_REQUEST_NODE_TYPE = _constantsLegacy00VJs.hn;
        AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE = _constantsLegacy00VJs.ht;
        AI_CATEGORY_RETRIEVERS = _constantsLegacy00VJs.it;
        require__arrayIncludesWith = _constantsLegacy00VJs.ji;
        TRIGGER_NODE_CREATOR_VIEW = _constantsLegacy00VJs.jt;
        MERGE_NODE_TYPE = _constantsLegacy00VJs.kn;
        TEMPLATE_CATEGORY_AI = _constantsLegacy00VJs.kt;
        FILTER_NODE_TYPE = _constantsLegacy00VJs.ln;
        AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = _constantsLegacy00VJs.lt;
        HTML_NODE_TYPE = _constantsLegacy00VJs.mn;
        AI_UNCATEGORIZED_CATEGORY = _constantsLegacy00VJs.mt;
        EMAIL_SEND_NODE_TYPE = _constantsLegacy00VJs.nn;
        PRE_BUILT_AGENTS_EXPERIMENT = _constantsLegacy00VJs.oc;
        SPLIT_IN_BATCHES_NODE_TYPE = _constantsLegacy00VJs.or;
        AI_CATEGORY_TEXT_SPLITTERS = _constantsLegacy00VJs.ot;
        AI_SUBCATEGORY = _constantsLegacy00VJs.pt;
        NODE_MIN_INPUT_ITEMS_COUNT = _constantsLegacy00VJs.q;
        EVALUATION_TRIGGER_NODE_TYPE = _constantsLegacy00VJs.ro;
        AI_CATEGORY_OUTPUTPARSER = _constantsLegacy00VJs.rt;
        EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE = _constantsLegacy00VJs.sn;
        SPLIT_OUT_NODE_TYPE = _constantsLegacy00VJs.sr;
        AI_CATEGORY_TOOLS = _constantsLegacy00VJs.st;
        getNodeInputs = _constantsLegacy00VJs.ta;
        EMAIL_IMAP_NODE_TYPE = _constantsLegacy00VJs.tn;
        SET_NODE_TYPE = _constantsLegacy00VJs.tr;
        AI_CATEGORY_MEMORY = _constantsLegacy00VJs.tt;
        WEBHOOK_NODE_TYPE = _constantsLegacy00VJs.vr;
        DEFAULT_SUBCATEGORY = _constantsLegacy00VJs.vt;
        XML_NODE_TYPE = _constantsLegacy00VJs.wr;
        OTHER_TRIGGER_NODES_SUBCATEGORY = _constantsLegacy00VJs.wt;
        require__cacheHas = _constantsLegacy00VJs.xo;
        HITL_SUBCATEGORY = _constantsLegacy00VJs.xt;
        FLOWS_CONTROL_SUBCATEGORY = _constantsLegacy00VJs.yt;
      }, function (_mergeLegacy00XJs) {
        require__baseUnary = _mergeLegacy00XJs.T;
        require__baseRest = _mergeLegacy00XJs.r;
        require_isArrayLikeObject = _mergeLegacy00XJs.u;
      ...
      }, function (_nodeIconLegacy01xJs) {
        getNodeIconSource = _nodeIconLegacy01xJs.t;
      }],
      execute: function () {
