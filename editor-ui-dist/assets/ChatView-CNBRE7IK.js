const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-C7mp7hE6.js","assets/core-DntzLlqD.js","assets/chunk-6z4oVpB-.js","assets/languageModules-FLPk4yY4.js","assets/xml-ByhzxXn2.js"])))=>i.map(i=>d[i]);
...
import { I as useSpeechRecognition, L as useSpeechSynthesis, M as useMediaQuery, P as useScroll, _t as useI18n, j as useLocalStorage, vt as I18nT } from "./_MapCache-BMxyEZko.js";
...
import { Bo as v4_default, Fi as useUIStore, Tn as useDocumentTitle, nr as useUsersStore } from "./useTelemetry-boGIPUKp.js";
...
import { $r as PROVIDER_CREDENTIAL_TYPE_MAP, Cs as LOCAL_STORAGE_CHAT_HUB_SELECTED_MODEL, Lo as VIEWS, gi as INodesSchema, ws as LOCAL_STORAGE_CHAT_HUB_SELECTED_TOOLS } from "./constants-DEJ0QFwr.js";
...
import { t as VueMarkdown_default } from "./VueMarkdown-8m5GTlkL.js";
...
import { c as isLlmProvider, f as unflattenModel, l as isLlmProviderModel, p as buildChatAttachmentUrl, r as findOneFromModelsResponse, t as useChatStore } from "./chat.store-KjCu88RI.js";
import "./fileUtils-BIVczUdz.js";
import { n as ModelSelector_default, t as ToolsSelector_default } from "./ToolsSelector-Dab-kr6q.js";
import { t as ChatAgentAvatar_default } from "./ChatAgentAvatar-Dt-Uf5v3.js";
import { i as chatHubConversationModelWithCachedDisplayNameSchema, n as ChatLayout_default, r as useChatCredentials, t as ChatSidebarOpener_default } from "./ChatSidebarOpener-BvaSEcVU.js";
import { t as useChatHubSidebarState } from "./useChatHubSidebarState-CUdvn5RW.js";
...
function useChatHubMarkdownOptions() {
	...
	async function loadLanguageModules() {
		...
		try {
			asyncImport = {
				status: "inProgress",
				promise: Promise.all([__vitePreload(() => import("./es-C7mp7hE6.js"), __vite__mapDeps([0,1,2])), __vitePreload(() => import("./languageModules-FLPk4yY4.js"), __vite__mapDeps([3,4]))])
			};
