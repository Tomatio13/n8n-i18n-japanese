;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-CVC6di38.js", "./useTelemetry-legacy-DyFWt8gD.js", "./useToast-legacy-CQPpmrHA.js", "./constants-legacy-DAaX1J_j.js", "./assistant.store-legacy-Dqfj_y-Y.js", "./useExternalHooks-legacy-BUVgQPZx.js", "./useWorkflowSaving-legacy-7aVpp8JN.js", "./useRunWorkflow-legacy-DYbEugng.js", "./schemaPreview.store-legacy-N955BjbP.js", "./readyToRunWorkflows.store-legacy-DtexqVGT.js", "./readyToRunWorkflowsV2.store-legacy-qrR0PMz3.js"], function (_export, _context) {
    "use strict";

    var ref, useI18n, getExecutionErrorToastConfiguration, isPrebuiltAgentTemplateId, useSettingsStore, useCredentialsStore, useUIStore, getExecutionErrorMessage, getTriggerNodeServiceName, injectWorkflowState, useDocumentTitle, useRootStore, defineStore, parse, isValidNodeConnectionType, sendGetWorkerStatus, codeNodeEditorEventBus, isTutorialTemplateId, globalLinkActionsEventBus, useWorkflowHelpers, useWorkflowsStore, clearPopupWindowState, useNodeTypesStore, useTelemetry, SampleTemplates, useNodeHelpers, useToast, TRIMMED_TASK_DATA_CONNECTIONS_KEY, isCommunityPackageName, EVALUATION_TRIGGER_NODE_TYPE, generateNodesGraph, WORKFLOW_SETTINGS_MODAL_KEY, useBuilderStore, useAssistantStore, useExternalHooks, useWorkflowSaving, usePushConnectionStore, useRunWorkflow, useSchemaPreviewStore, useAITemplatesStarterCollectionStore, useReadyToRunWorkflowsStore, useReadyToRunWorkflowsV2Store, WORKER_HISTORY_LENGTH, STALE_SECONDS, useOrchestrationStore;
    ...
    */
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        sendGetWorkerStatus = _useTelemetryLegacy00FJs.hs;
