;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-CVC6di38.js", "./src-legacy-DaU7H7T8.js", "./truncate-legacy-BWR_lVFz.js", "./useTelemetry-legacy-DyFWt8gD.js", "./useToast-legacy-CQPpmrHA.js", "./constants-legacy-DAaX1J_j.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, createElementBlock, unref, ref, h, defineComponent, toDisplayString, watch, openBlock, createTextVNode, createBaseVNode, useI18n, isWorkflowUpdatedMessage, isToolMessage, createEventBus, useRoute, useSettingsStore, useCredentialsStore, getSessionsMetadata, getAuthTypeForNodeCredential, getAiSessions, useUIStore, STORES, injectWorkflowState, CREDENTIAL_EDIT_MODAL_KEY, chatWithAssistant, chatWithBuilder, useAIAssistantHelpers, replaceCode, useRootStore, useNDVStore, defineStore, useUsersStore, assert, codeNodeEditorEventBus, useWorkflowsStore, getMainAuthField, getBuilderCredits, useNodeTypesStore, useTelemetry, stringSizeInBytes, useToast, require_pick, jsonParse, deepCopy, EDITABLE_CANVAS_VIEWS, VIEWS, PLACEHOLDER_EMPTY_WORKFLOW_ID, DEFAULT_NEW_WORKFLOW_NAME, ASSISTANT_ENABLED_VIEWS, BUILDER_ENABLED_VIEWS, import_pick, INFINITE_CREDITS, useBuilderStore, DEFAULT_CHAT_WIDTH, useChatPanelStateStore, ndvEventBus, _hoisted_1, AiUpdatedCodeMessage_vue_vue_type_script_setup_true_lang_default, AiUpdatedCodeMessage_default, READABLE_TYPES, useAssistantStore;
    //#endregion
