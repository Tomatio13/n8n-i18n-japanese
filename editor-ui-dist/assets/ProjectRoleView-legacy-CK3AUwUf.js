        ...
        ProjectRoleView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          setup(__props) {
            ...
            const defaultForm = () => ({
              displayName: "",
              description: "",
              scopes: ["project:read", "project:list", "folder:read", "folder:list", "workflow:read", "workflow:list", "credential:read", "credential:list"]
            });
            ...
            const scopeTypes = ["project", "folder", "workflow", "credential", "sourceControl"];
            const scopes = {
              project,
              folder,
              workflow,
