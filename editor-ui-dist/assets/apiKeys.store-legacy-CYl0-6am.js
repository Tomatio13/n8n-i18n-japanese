...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./useTelemetry-legacy-DyFWt8gD.js"], function (_export, _context) {
    ...
    var computed, ref, getApiKeyScopes, createApiKey, STORES, updateApiKey, getApiKeys, useRootStore, defineStore, deleteApiKey, useApiKeysStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        computed = _vueRuntimeEsmBundlerLegacy003Js.C;
        ref = _vueRuntimeEsmBundlerLegacy003Js.It;
      }, function (_useTelemetryLegacy00FJs) {
        getApiKeyScopes = _useTelemetryLegacy00FJs.Js;
        createApiKey = _useTelemetryLegacy00FJs.Ks;
        STORES = _useTelemetryLegacy00FJs.Sc;
        updateApiKey = _useTelemetryLegacy00FJs.Xs;
        getApiKeys = _useTelemetryLegacy00FJs.Ys;
        useRootStore = _useTelemetryLegacy00FJs.Zs;
        defineStore = _useTelemetryLegacy00FJs.bc;
        deleteApiKey = _useTelemetryLegacy00FJs.qs;
      }],
      execute: function () {
