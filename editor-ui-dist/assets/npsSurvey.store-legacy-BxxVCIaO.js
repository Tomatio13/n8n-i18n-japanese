;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./useTelemetry-legacy-VnN6Lamb.js", "./constants-legacy-CUFnuZt5.js", "./_baseOrderBy-legacy-_y5jgHlf.js"], function (_export, _context) {
    "use strict";

    var ref, useUIStore, useSettingsStore, updateNpsSurveyState, getPromptsData, SEVEN_DAYS_IN_MILLIS, THREE_DAYS_IN_MILLIS, CONTACT_PROMPT_MODAL_KEY, NPS_SURVEY_MODAL_KEY, SIX_MONTHS_IN_MILLIS, assert, defineStore, useRootStore, MAXIMUM_TIMES_TO_SHOW_SURVEY_IF_IGNORED, useNpsSurveyStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        SEVEN_DAYS_IN_MILLIS = _constantsLegacy00TJs.Cc;
        THREE_DAYS_IN_MILLIS = _constantsLegacy00TJs.Tc;
        CONTACT_PROMPT_MODAL_KEY = _constantsLegacy00TJs.Uo;
        NPS_SURVEY_MODAL_KEY = _constantsLegacy00TJs.as;
        SIX_MONTHS_IN_MILLIS = _constantsLegacy00TJs.wc;
