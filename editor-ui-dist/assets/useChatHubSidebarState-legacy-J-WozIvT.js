;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-CVC6di38.js", "./src-legacy-DaU7H7T8.js", "./useTelemetry-legacy-DyFWt8gD.js", "./constants-legacy-DAaX1J_j.js", "./retry-legacy-CkXCWkMV.js", "./CredentialIcon-legacy-B_gWeYoh.js", "./constants-legacy-D22nGw-a.js"], function (_export, _context) {
    "use strict";

    var computed, unref, ref, defineComponent, toDisplayString, createBlock, withCtx, openBlock, createTextVNode, createSlots, useMediaQuery, useLocalStorage, N8nAvatar_default, N8nTooltip_default, N8nIcon_default, v4_default, useUIStore, useRootStore, defineStore, makeRestApiRequest, useUsersStore, streamRequest, LOCAL_STORAGE_CHAT_HUB_STATIC_SIDEBAR, PROVIDER_CREDENTIAL_TYPE_MAP, chatHubProviderSchema, emptyChatModelsResponse, CHAT_HUB_SIDE_MENU_DRAWER_MODAL_KEY, retry, CredentialIcon_default, MOBILE_MEDIA_QUERY, CHAT_VIEW, CHAT_STORE, STREAM_SEPARATOR, fetchChatModelsApi, stopGenerationApi, fetchConversationsApi, updateConversationApi, updateConversationTitleApi, deleteConversationApi, fetchSingleConversationApi, fetchAgentApi, createAgentApi, updateAgentApi, deleteAgentApi, useChatStore, ChatAgentAvatar_vue_vue_type_script_setup_true_lang_default, ChatAgentAvatar_default;
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        streamRequest = _useTelemetryLegacy00FJs.pc;
