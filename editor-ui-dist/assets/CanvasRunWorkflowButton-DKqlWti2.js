...
import { _ as onKeyDown, bt as I18nT, ct as watchOnce, lt as watchThrottled, ot as useThrottleFn, y as onKeyUp, yt as useI18n } from "./_MapCache-BSabmsGd.js";
...
import { $n as TemplateClickSource, $r as CanvasNodeDirtiness, Ai as getTriggerNodeServiceName, Bn as _sfc_main$3, C as useNodeTypesStore, Ec as sanitizeHtml, Fn as NodeId, Ft as useNDVStore, Gn as getBoundsofRects, Hn as _sfc_main$f, In as PanelPosition, It as injectWorkflowState, Jn as getSmoothStepPath, Jr as isValidNodeConnectionType, Kn as getConnectedEdges, Ln as Position, Mt as useTelemetry, Nn as updateViewportToContainNodes, On as getMousePosition, Or as v4_default, Pn as MarkerType, Qn as wheelDelta, Qr as CanvasConnectionMode, Rn as _sfc_main$4, Sn as calculateNodeSize, Tc as isOutsideSelected, Un as clamp, Vn as _sfc_main$d, Wn as getBezierPath, Xi as isPresent, Xn as useGetPointerPosition, Yn as isMacOs, Zn as useVueFlow, bn as GRID_SIZE, d as isChatNode, ds as useSettingsStore, ei as CanvasNodeRenderType, er as isExtraTemplateLinksExperimentEnabled, gn as CONFIGURATION_NODE_RADIUS, hr as useStyles, ia as nodeViewEventBus, jt as useNodeHelpers, kt as environments_store_default, mn as useTemplatesStore, mr as useToast, nr as useTemplatesDataQualityStore, qn as getRectOfNodes, r as useUIStore, s as useWorkflowsStore, sa as globalLinkActionsEventBus, ti as useHistoryStore, tr as trackTemplatesClick, vn as DEFAULT_NODE_SIZE, xn as PUSH_NODES_OFFSET, yr as useSourceControlStore, zn as _sfc_main$1 } from "./users.store-CRuM-6OK.js";
import { A as TitledList_default } from "./ParameterInputList-CTLrpf2x.js";
import { $o as EXPERIMENT_TEMPLATES_DATA_QUALITY_KEY, Cs as WORKFLOW_EXTRACTION_NAME_MODAL_KEY, F as CUSTOM_API_CALL_KEY, Gn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Ln as NOT_DUPLICATABLE_NODE_TYPES, Oc as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, Po as getResourcePermissions, Wo as VIEWS, ac as CanvasNodeHandleKey, bo as WEBHOOK_NODE_TYPE, da as isNodeWithWorkflowSelector, ea as getNodeInputs, go as SEND_AND_WAIT_OPERATION, gr as WAIT_NODE_TYPE, ic as CanvasKey, ir as SIMULATE_TRIGGER_NODE_TYPE, ka as isCommunityPackageName, ln as FORM_NODE_TYPE, lr as STICKY_NODE_TYPE, mi as parseExtractableSubgraphSelection, oc as CanvasNodeKey, pi as buildAdjacencyList, qa as NodeConnectionTypes, qi as mapConnectionsByDestination, rr as SIMULATE_NODE_TYPE, sa as getSubworkflowId, sc as ExpressionLocalResolveContextSymbol, so as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, ta as getNodeOutputs, ua as isExecutable, xo as require_isEqual, xt as NODE_CREATOR_OPEN_SOURCES, yi as extractReferencesInNodeExpressions, yo as WAIT_INDEFINITELY, zt as CHAT_TRIGGER_NODE_TYPE } from "./constants-jSlGi3TV.js";
...
import { t as usePinnedData } from "./usePinnedData-DDLJY1l7.js";
import { t as useNodeCreatorStore } from "./nodeCreator.store-DrJWiNBr.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections, r as insertSpacersBetweenEndpoints, s as mapLegacyEndpointsToCanvasConnectionPort, t as checkOverlap } from "./canvas.utils-B46ithaJ.js";
import { t as getNodeIconSource } from "./nodeIcon-BtE0OHHC.js";
import { a as useLogsStore, i as useExperimentalNdvStore, t as useCanvasOperations } from "./useCanvasOperations-DTJDjav-.js";
...
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-z6fPDDE1.js";
import { t as useCollaborationStore } from "./collaboration.store-CULLK6ED.js";
import { t as NodeSettings_default } from "./NodeSettings-6e-bMc5I.js";
