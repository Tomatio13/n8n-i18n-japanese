const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/InsightsPaywall-B_CV5mOE.js","assets/index-bHaUIFge.js","assets/index-Ed_z14lJ.css","assets/InsightsPaywall-CE5W3W4m.css","assets/InsightsChartTotal-kw7QKDsC.js","assets/chartjs.utils-DSU-N6ld.js","assets/InsightsSummary-DoP6eM3Z.js","assets/InsightsSummary-DzGQpM5h.css","assets/index-CTBrq_ct.js","assets/InsightsChartFailed-BaRCyzA0.js","assets/InsightsChartFailureRate-B5kf7z2q.js","assets/InsightsChartTimeSaved-C6AdrGo-.js","assets/InsightsChartAverageRuntime-BZuFQibp.js","assets/InsightsTableWorkflows-B44B7Ay4.js","assets/InsightsTableWorkflows-DfTZQkWL.css"])))=>i.map(i=>d[i]);
import { d as defineComponent, f4 as useModel, g0 as useInsightsStore, r as ref, gl as UNLICENSED_TIME_RANGE, g7 as TIME_RANGE_LABELS, e as createBlock, g as openBlock, w as withCtx, i as createElementBlock, F as Fragment, D as renderList, m as unref, em as _sfc_main$3, l as createTextVNode, f as createCommentVNode, t as toDisplayString, k as createBaseVNode, en as N8nSelect, q as computed, c as useI18n, j as createVNode, bf as N8nText, bh as N8nButton, gm as ElDialog, a6 as usePageRedirectionHelper, _ as _export_sfc, ca as defineAsyncComponent, X as watch, h as resolveComponent, n as normalizeClass, b7 as resolveDynamicComponent, ao as __vitePreload, ag as useTelemetry, gn as TELEMETRY_TIME_RANGE } from "./index-bHaUIFge.js";
import { I as InsightsSummary } from "./InsightsSummary-DoP6eM3Z.js";
const _hoisted_1$2 = {
  key: 0,
  width: "16",
  height: "17",
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const InsightsPaywall = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsPaywall-B_CV5mOE.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0)
    );
    const InsightsChartTotal = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTotal-kw7QKDsC.js"), true ? __vite__mapDeps([4,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailed = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailed-BaRCyzA0.js"), true ? __vite__mapDeps([9,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartFailureRate = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartFailureRate-B5kf7z2q.js"), true ? __vite__mapDeps([10,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartTimeSaved = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartTimeSaved-C6AdrGo-.js"), true ? __vite__mapDeps([11,1,2,5,6,7,8]) : void 0)
    );
    const InsightsChartAverageRuntime = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsChartAverageRuntime-BZuFQibp.js"), true ? __vite__mapDeps([12,1,2,5,6,7,8]) : void 0)
    );
    const InsightsTableWorkflows = defineAsyncComponent(
      async () => await __vitePreload(() => import("./InsightsTableWorkflows-B44B7Ay4.js"), true ? __vite__mapDeps([13,1,2,6,7,14]) : void 0)
    );
    const props = __props;
    const i18n = useI18n();
