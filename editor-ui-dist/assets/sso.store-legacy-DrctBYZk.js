;
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./useTelemetry-legacy-DyFWt8gD.js"], function (_export, _context) {
    "use strict";

    var computed, ref, getOidcConfig, UserManagementAuthenticationMethod, useRootStore, getLdapConfig, testSamlConfig, defineStore, testLdapConnection, getSamlConfig, saveSamlConfig, initSSO, toggleSamlConfig, saveOidcConfig, getSamlMetadata, getLdapSynchronizations, updateLdapConfig, runLdapSync, SupportedProtocols, useSSOStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        computed = _vueRuntimeEsmBundlerLegacy003Js.C;
        ref = _vueRuntimeEsmBundlerLegacy003Js.It;
      }, function (_useTelemetryLegacy00FJs) {
        getOidcConfig = _useTelemetryLegacy00FJs.$o;
        UserManagementAuthenticationMethod = _useTelemetryLegacy00FJs.$s;
        useRootStore = _useTelemetryLegacy00FJs.Zs;
        getLdapConfig = _useTelemetryLegacy00FJs._s;
        testSamlConfig = _useTelemetryLegacy00FJs.as;
        defineStore = _useTelemetryLegacy00FJs.bc;
        testLdapConnection = _useTelemetryLegacy00FJs.bs;
        getSamlConfig = _useTelemetryLegacy00FJs.es;
        saveSamlConfig = _useTelemetryLegacy00FJs.is;
        initSSO = _useTelemetryLegacy00FJs.ns;
        toggleSamlConfig = _useTelemetryLegacy00FJs.os;
        saveOidcConfig = _useTelemetryLegacy00FJs.rs;
        getSamlMetadata = _useTelemetryLegacy00FJs.ts;
        getLdapSynchronizations = _useTelemetryLegacy00FJs.vs;
        updateLdapConfig = _useTelemetryLegacy00FJs.xs;
        runLdapSync = _useTelemetryLegacy00FJs.ys;
      }],
      execute: function () {
