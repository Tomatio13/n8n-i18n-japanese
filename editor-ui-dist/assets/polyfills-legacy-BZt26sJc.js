(function() {
	...
	var require_function_uncurry_this_accessor = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(object, key$1, method) {
			try {
				return uncurryThis$17(aCallable$5(Object.getOwnPropertyDescriptor(object, key$1)[method]));
			} catch (error) {}
		};
	}));
	...
	var require_well_known_symbol_define = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function(NAME$1) {
			...
			if (!hasOwn$3(Symbol$4, NAME$1)) defineProperty$3(Symbol$4, NAME$1, { value: wrappedWellKnownSymbolModule.f(NAME$1) });
		};
	}));
	...
	if (Symbol$2) {
		...
		if (descriptor$1.enumerable && descriptor$1.configurable && descriptor$1.writable) defineProperty$2(Symbol$2, "asyncDispose", {
	...
	if (Symbol$1) {
		...
		if (descriptor.enumerable && descriptor.configurable && descriptor.writable) defineProperty$1(Symbol$1, "dispose", {
	...
	var require_async_iterator_prototype = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		else if (IS_PURE$1) AsyncIteratorPrototype$1 = create$1(AsyncIteratorPrototype$1);
	...
	var require_array_group = /* @__PURE__ */ __commonJSMin(((exports, module) => {
		...
		module.exports = function($this, callbackfn, that, specificConstructor) {
			...
			for (; length > index; index++) {
				...
				if (key$1 in target) push(target[key$1], value);
