...
import { ft as isToolMessage, pt as isWorkflowUpdatedMessage } from "./src-C-TA4HUG.js";
import { x as createEventBus, y as useRoute } from "./truncate-BfTdoaZc.js";
import { Ci as stringSizeInBytes, Do as CREDENTIAL_EDIT_MODAL_KEY, Fi as useUIStore, Ht as useCredentialsStore, Jr as getAuthTypeForNodeCredential, Jt as getSessionsMetadata, Kt as getAiSessions, Ni as codeNodeEditorEventBus, Sn as injectWorkflowState, Ut as chatWithAssistant, Wo as useSettingsStore, Wt as chatWithBuilder, Xt as useAIAssistantHelpers, Yr as getMainAuthField, Yt as replaceCode, a as useNDVStore, at as useNodeTypesStore, cc as STORES, i as usePostHog, nr as useUsersStore, o as useWorkflowsStore, qt as getBuilderCredits, t as useTelemetry } from "./useTelemetry-boGIPUKp.js";
import { t as useToast } from "./useToast-9Rtux9-k.js";
import { Ea as deepCopy, Fo as EDITABLE_CANVAS_VIEWS, Lo as VIEWS, c as PLACEHOLDER_EMPTY_WORKFLOW_ID, ci as require_pick, ka as jsonParse, nc as AI_BUILDER_MULTI_AGENT_EXPERIMENT, rc as AI_BUILDER_TEMPLATE_EXAMPLES_EXPERIMENT, t as DEFAULT_NEW_WORKFLOW_NAME } from "./constants-DEJ0QFwr.js";
import { g as assert, k as defineStore, r as useRootStore } from "./_baseOrderBy-B5r0-oAm.js";
