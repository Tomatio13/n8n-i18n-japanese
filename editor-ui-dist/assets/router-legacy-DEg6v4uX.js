;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-8OcfWMWH.js", "./src-legacy-D1xm8eXd.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-pXf4oSuB.js", "./empty-legacy-ZG0-xpne.js", "./useTelemetry-legacy-B6y_voo5.js", "./useToast-legacy-DjBjYx4v.js", "./sanitize-html-legacy-B93rGWi4.js", "./constants-legacy-CTwBfCBA.js", "./_baseOrderBy-legacy-BqEyX22w.js", "./useExternalHooks-legacy-DddL2e0w.js", "./npsSurvey.store-legacy-Hxroo5xS.js", "./cloudPlan.store-legacy-BqPyx0nU.js", "./templates.store-legacy-dBXa5ci3.js", "./nodeCreator.store-legacy-CBJxxhVc.js", "./versions.store-legacy-fslHMHJd.js", "./banners.store-legacy-BPfvTuv1.js", "./dataTable.store-legacy-BUIiKyot.js", "./CredentialIcon-legacy-OnEmI43C.js", "./TimeAgo-legacy-BD0TAU-x.js", "./roles.store-legacy-ORiIu_4w.js", "./sso.store-legacy-bvXErgEc.js", "./insights.store-legacy-D4AlS7Lj.js", "./mcp.constants-legacy-BkbTHrFy.js", "./constants-legacy-DjFSod4r.js", "./chat.store-legacy-yDP5j3Ix.js", "./useRecentResources-legacy-lztrNGtb.js"], function (_export, _context) {
    "use strict";
    ...
    */
    ...
    return {
      ...
      execute: function () {
        ...
        i18n$2 = useI18n();
        MainSidebar$3 = async () => await __vitePreload(() => _context.import("./MainSidebar-legacy-CObTMUL1.js"), true               ? void 0 : void 0);
        DataTableView = async () => await __vitePreload(() => _context.import("./DataTableView-legacy-Bupm7WT-.js"), true               ? void 0 : void 0);
        DataTableDetailsView = async () => await __vitePreload(() => _context.import("./DataTableDetailsView-legacy-BDAQm71A.js"), true               ? void 0 : void 0);
        DataTableModule = {
          id: "data-table",
          name: "Data Table",
          ...
          modals: [{
            ...
            component: async () => await __vitePreload(() => _context.import("./AddDataTableModal-legacy-CATalO3D.js"), true               ? void 0 : void 0),
            initialState: {
              open: false
            }
          }],
        ...
        MainSidebar$2 = async () => await __vitePreload(() => _context.import("./MainSidebar-legacy-CObTMUL1.js"), true               ? void 0 : void 0);
        InsightsDashboard = async () => await __vitePreload(() => _context.import("./InsightsDashboard-legacy-qf0dRpd1.js"), true               ? void 0 : void 0);
        InsightsModule = {
          id: "insights",
          name: "Insights",
        ...
        i18n$1 = useI18n();
        SettingsMCPView = async () => await __vitePreload(() => _context.import("./SettingsMCPView-legacy-ClF9mvfr.js"), true               ? void 0 : void 0);
        MCPModule = {
          id: "mcp",
          name: "MCP Access",
        ...
        ChatSidebar = async () => await __vitePreload(() => _context.import("./ChatSidebar-legacy-CyYGrLi9.js"), true               ? void 0 : void 0);
        ChatView = async () => await __vitePreload(() => _context.import("./ChatView-legacy-DlpLUbJS.js"), true               ? void 0 : void 0);
        ChatAgentsView = async () => await __vitePreload(() => _context.import("./ChatAgentsView-legacy-D_jE43zc.js"), true               ? void 0 : void 0);
        ChatModule = {
          id: "chat-hub",
          name: "Chat",
          ...
          modals: [{
            ...
            component: async () => await __vitePreload(() => _context.import("./ToolsSelectorModal-legacy-DYVGUiCp.js"), true               ? void 0 : void 0),
            initialState: {
              open: false,
              data: {
                selected: [],
            ...
            component: async () => await __vitePreload(() => _context.import("./AgentEditorModal-legacy-fefQqygB.js"), true               ? void 0 : void 0),
            initialState: {
              open: false,
              data: {
                credentials: {},
            ...
            component: async () => await __vitePreload(() => _context.import("./CredentialSelectorModal-legacy-CCfAO_kh.js"), true               ? void 0 : void 0),
            initialState: {
              open: false,
              data: {
                provider: null,
            ...
            component: async () => await __vitePreload(() => _context.import("./ModelByIdSelectorModal-legacy-lmqJrfyV.js"), true               ? void 0 : void 0),
            initialState: {
              open: false,
              data: {
                provider: null,
            ...
            component: async () => await __vitePreload(() => _context.import("./ProviderSettingsModal-legacy-a51fI8np.js"), true               ? void 0 : void 0),
            initialState: {
              open: false,
              data: {
                provider: null,
        ...
        */
        ...
        MainSidebar$1 = async () => await __vitePreload(() => _context.import("./MainSidebar-legacy-CObTMUL1.js"), true               ? void 0 : void 0);
        WorkflowsView = async () => await __vitePreload(() => _context.import("./WorkflowsView-legacy-QU6x-bok.js"), true               ? void 0 : void 0);
        CredentialsView = async () => await __vitePreload(() => _context.import("./CredentialsView-legacy-COG2poSg.js"), true               ? void 0 : void 0);
        ProjectSettings = async () => await __vitePreload(() => _context.import("./ProjectSettings-legacy-BdrugzXo.js"), true               ? void 0 : void 0);
        ExecutionsView = async () => await __vitePreload(() => _context.import("./ExecutionsView-legacy-DaWUYLa_.js"), true               ? void 0 : void 0);
        ProjectVariables = async () => await __vitePreload(() => _context.import("./ProjectVariables-legacy-BpZ_e_Hb.js"), true               ? void 0 : void 0);
        ...
        ChangePasswordView = async () => await __vitePreload(() => _context.import("./ChangePasswordView-legacy-BBcyvj3g.js"), true               ? void 0 : void 0);
        ErrorView = async () => await __vitePreload(() => _context.import("./ErrorView-legacy-BLfiJMRz.js"), true               ? void 0 : void 0);
        ...
        OAuthConsentView = async () => await __vitePreload(() => _context.import("./OAuthConsentView-legacy-DBRTY0oT.js"), true               ? void 0 : void 0);
        ForgotMyPasswordView = async () => await __vitePreload(() => _context.import("./ForgotMyPasswordView-legacy-CDsCcdM9.js"), true               ? void 0 : void 0);
        MainHeader = async () => await __vitePreload(() => _context.import("./MainHeader-legacy-DPZz51Zn.js"), true               ? void 0 : void 0);
        MainSidebar = async () => await __vitePreload(() => _context.import("./MainSidebar-legacy-CObTMUL1.js"), true               ? void 0 : void 0);
        LogsPanel = async () => await __vitePreload(() => _context.import("./LogsPanel-legacy-CHVYBQ86.js"), true               ? void 0 : void 0);
        DemoFooter = async () => await __vitePreload(() => _context.import("./DemoFooter-legacy-C5JJmqNK.js"), true               ? void 0 : void 0);
        NodeView = async () => await __vitePreload(() => _context.import("./NodeView-legacy-aUWqc6jc.js"), true               ? void 0 : void 0);
        WorkflowExecutionsView = async () => await __vitePreload(() => _context.import("./WorkflowExecutionsView-legacy-l7WPY3xY.js"), true               ? void 0 : void 0);
        WorkflowExecutionsLandingPage = async () => await __vitePreload(() => _context.import("./WorkflowExecutionsLandingPage-legacy-ah6C6DoQ.js"), true               ? void 0 : void 0);
        WorkflowExecutionsPreview = async () => await __vitePreload(() => _context.import("./WorkflowExecutionsPreview-legacy-Pzaovs_j.js"), true               ? void 0 : void 0);
        SettingsView = async () => await __vitePreload(() => _context.import("./SettingsView-legacy-DxNQOz_a.js"), true               ? void 0 : void 0);
        SettingsLdapView = async () => await __vitePreload(() => _context.import("./SettingsLdapView-legacy-CAvaShwv.js"), true               ? void 0 : void 0);
        SettingsPersonalView = async () => await __vitePreload(() => _context.import("./SettingsPersonalView-legacy-FxPR7xgm.js"), true               ? void 0 : void 0);
        SettingsUsersView = async () => await __vitePreload(() => _context.import("./SettingsUsersView-legacy-CEZiGWls.js"), true               ? void 0 : void 0);
        SettingsCommunityNodesView = async () => await __vitePreload(() => _context.import("./SettingsCommunityNodesView-legacy-DKmmNH6U.js"), true               ? void 0 : void 0);
        SettingsApiView = async () => await __vitePreload(() => _context.import("./SettingsApiView-legacy-DbyLUfn8.js"), true               ? void 0 : void 0);
        SettingsLogStreamingView = async () => await __vitePreload(() => _context.import("./SettingsLogStreamingView-legacy-COT1dbbm.js"), true               ? void 0 : void 0);
        SetupView = async () => await __vitePreload(() => _context.import("./SetupView-legacy-DYaSv6z6.js"), true               ? void 0 : void 0);
        SigninView = async () => await __vitePreload(() => _context.import("./SigninView-legacy-B6ZAicxL.js"), true               ? void 0 : void 0);
        SignupView = async () => await __vitePreload(() => _context.import("./SignupView-legacy-BYmWE36k.js"), true               ? void 0 : void 0);
        TemplatesCollectionView = async () => await __vitePreload(() => _context.import("./TemplatesCollectionView-legacy-Bz94mlVC.js"), true               ? void 0 : void 0);
        TemplatesWorkflowView = async () => await __vitePreload(() => _context.import("./TemplatesWorkflowView-legacy-BLlHJoRN.js"), true               ? void 0 : void 0);
        SetupWorkflowFromTemplateView = async () => await __vitePreload(() => _context.import("./SetupWorkflowFromTemplateView-legacy-JaCYEOFm.js"), true               ? void 0 : void 0);
        TemplatesSearchView = async () => await __vitePreload(() => _context.import("./TemplatesSearchView-legacy-zvwN0Oub.js"), true               ? void 0 : void 0);
        SettingsUsageAndPlan = async () => await __vitePreload(() => _context.import("./SettingsUsageAndPlan-legacy-LgXZZP6s.js"), true               ? void 0 : void 0);
        SettingsSso = async () => await __vitePreload(() => _context.import("./SettingsSso-legacy-B4L0RYtX.js"), true               ? void 0 : void 0);
        SignoutView = async () => await __vitePreload(() => _context.import("./SignoutView-legacy-A-wku-dV.js"), true               ? void 0 : void 0);
        SamlOnboarding = async () => await __vitePreload(() => _context.import("./SamlOnboarding-legacy-ZFj8Ns20.js"), true               ? void 0 : void 0);
        SettingsSourceControl = async () => await __vitePreload(() => _context.import("./SettingsSourceControl-legacy-Co8m6eD0.js"), true               ? void 0 : void 0);
        SettingsExternalSecrets = async () => await __vitePreload(() => _context.import("./SettingsExternalSecrets-legacy-Ca-1nD18.js"), true               ? void 0 : void 0);
        WorkerView = async () => await __vitePreload(() => _context.import("./WorkerView-legacy-GFlyM-io.js"), true               ? void 0 : void 0);
        WorkflowHistory = async () => await __vitePreload(() => _context.import("./WorkflowHistory-legacy-DS1OD-Zy.js"), true               ? void 0 : void 0);
        WorkflowOnboardingView = async () => await __vitePreload(() => _context.import("./WorkflowOnboardingView-legacy-DlZV8ZDk.js"), true               ? void 0 : void 0);
        EvaluationsView = async () => await __vitePreload(() => _context.import("./EvaluationsView-legacy-DqsrL7F0.js"), true               ? void 0 : void 0);
        TestRunDetailView = async () => await __vitePreload(() => _context.import("./TestRunDetailView-legacy-Ddpv1wEp.js"), true               ? void 0 : void 0);
        EvaluationRootView = async () => await __vitePreload(() => _context.import("./EvaluationsRootView-legacy-B_MgzAbG.js"), true               ? void 0 : void 0);
        PrebuiltAgentTemplatesView = async () => await __vitePreload(() => _context.import("./PrebuiltAgentTemplatesView-legacy-CN396VDI.js"), true               ? void 0 : void 0);
        MigrationReportView = async () => await __vitePreload(() => _context.import("./MigrationRules-legacy-BIFzIb5x.js"), true               ? void 0 : void 0);
        MigrationRuleReportView = async () => await __vitePreload(() => _context.import("./MigrationRuleDetail-legacy-2y4mkUMT.js"), true               ? void 0 : void 0);
        routes = [{
          path: "/",
          redirect: "/home/workflows",
          meta: {
          ...
          children: [{
            ...
            children: [{
              ...
              component: async () => await __vitePreload(() => _context.import("./ProjectRolesView-legacy-ZThcKcTk.js"), true               ? void 0 : void 0)
            }, {
              path: "new",
              name: VIEWS.PROJECT_NEW_ROLE,
              component: async () => await __vitePreload(() => _context.import("./ProjectRoleView-legacy-CedF6pFN.js"), true               ? void 0 : void 0)
            }, {
              path: "edit/:roleSlug",
