  ...
  System.register(["./vue.runtime.esm-bundler-legacy--Sn1h8On.js", "./_MapCache-legacy-8OcfWMWH.js", "./src-legacy-CqaaMy6r.js", "./en-legacy-DJK4SpPN.js", "./preload-helper-legacy-CXRjoQ0T.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-COQs_hNk.js", "./icon-legacy-BBcLFUR7.js", "./date-picker-legacy-pgsYnfJ9.js", "./overlay-legacy-C5eIW3LW.js", "./ParameterInputList-legacy-mE5ZFU_F.js", "./empty-legacy-DFAcggMu.js", "./useMessage-legacy-BW-CeYwb.js", "./col-legacy-B07CIjEP.js", "./dialog-legacy-D14RDI0B.js", "./useTelemetry-legacy-DRbFTEPe.js", "./useToast-legacy-DFHug49l.js", "./sanitize-html-legacy-C2e3AnhY.js", "./CalendarDate-legacy-BUvNgcoo.js", "./constants-legacy-BnN5j0Of.js", "./merge-legacy-Bk31cAi2.js", "./assistant.store-legacy-CUYyVmDh.js", "./_baseOrderBy-legacy-Helkyheh.js", "./dateformat-legacy-COtwsT2o.js", "./useDebounce-legacy-vbPtOpN1.js", "./useExternalHooks-legacy-cRYXgFRw.js", "./useStyles-legacy-CBz5KLcN.js", "./chatPanel.store-legacy-CeS-upSx.js", "./npsSurvey.store-legacy-Q5270ueJ.js", "./cloudPlan.store-legacy-DSxOgyF2.js", "./templates.store-legacy-COMhIBM_.js", "./focusPanel.store-legacy-DusQaRaH.js", "./useWorkflowSaving-legacy-Dq2J0c0I.js", "./retry-legacy-B42G2wo4.js", "./executions.store-legacy-DjLRUG05.js", "./useRunWorkflow-legacy-B3yEnVQV.js", "./usePinnedData-legacy-CTnrlng4.js", "./nodeCreator.store-legacy-sgQV_e2e.js", "./nodeIcon-legacy-6VM1SPil.js", "./useClipboard-legacy-BwBYkCQ-.js", "./useCanvasOperations-legacy-DJTHHHri.js", "./folders.store-legacy-DMaO_v_N.js", "./NodeIcon-legacy-CZeTeOCV.js", "./KeyboardShortcutTooltip-legacy-Bfi5Id0D.js", "./useCanvasMapping-legacy-Hm2Slg73.js", "./versions.store-legacy-B7m78ucL.js", "./usePageRedirectionHelper-legacy-C60tsIw7.js", "./dataTable.store-legacy-dNdmaLWv.js", "./isEmpty-legacy-BNbfS6F1.js", "./NDVEmptyState-legacy-DrLNao3O.js", "./exports-legacy-BtRwEZI4.js", "./externalSecrets.ee.store-legacy-C4lRdyse.js", "./uniqBy-legacy-D85i6pHx.js", "./semver-legacy-BfnEEa7V.js", "./CommunityNodeUpdateInfo-legacy-Cle37THG.js", "./RunDataHtml-legacy-250--9xW.js", "./VueMarkdown-legacy-S4e6uB-V.js", "./Draggable-legacy-f8rMeVoT.js", "./VirtualSchema-legacy-BDjKIKAh.js", "./TextWithHighlights-legacy-pZhi9EEL.js", "./useTelemetryContext-legacy-kN-WHfNu.js", "./schemaPreview.store-legacy-DXqgJCTm.js", "./nodeTransforms-legacy-DbZ5H2Eu.js", "./FileSaver.min-legacy-0SsKJJ7L.js", "./vue-json-pretty-legacy-DEs9LQ9L.js", "./dateFormatter-legacy-4CGynHJz.js", "./useExecutionHelpers-legacy-DWK5_MUe.js", "./NodeSettings-legacy-_2FVh5qB.js", "./useActions-legacy-Ct-sGy7D.js", "./vue-legacy-DEng36nH.js", "./sourceControl.eventBus-legacy-SETt_W5Y.js", "./useKeybindings-legacy-DA70lviA.js", "./useBeforeUnload-legacy-DiyE8sJD.js", "./aiTemplatesStarterCollection.store-legacy-DT4mR0hB.js", "./useExecutionData-legacy-Bd3m6Sp7.js", "./useExecutionDebugging-legacy-B9xRh8ep.js", "./readyToRunWorkflows.store-legacy-BdxjF19K.js"], function (_export, _context) {
    ...
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        jsonParse = _constantsLegacy00VJs.Aa;
        CHAT_TRIGGER_NODE_TYPE = _constantsLegacy00VJs.Bt;
        NODE_CREATOR_OPEN_SOURCES = _constantsLegacy00VJs.Ct;
        getResourcePermissions = _constantsLegacy00VJs.Do;
        MAIN_HEADER_TABS = _constantsLegacy00VJs.Fo;
        VIEWS = _constantsLegacy00VJs.Io;
        FROM_AI_PARAMETERS_MODAL_KEY = _constantsLegacy00VJs.Jo;
        PRODUCTION_ONLY_TRIGGER_NODE_TYPES = _constantsLegacy00VJs.Kn;
        ABOUT_MODAL_KEY = _constantsLegacy00VJs.Lo;
        VALID_WORKFLOW_IMPORT_URL_REGEX = _constantsLegacy00VJs.M;
        AI_TRANSFORM_NODE_TYPE = _constantsLegacy00VJs.Qa;
        DRAG_EVENT_DATA_KEY = _constantsLegacy00VJs.R;
        isResourceLocatorValue = _constantsLegacy00VJs.Sa;
        MANUAL_CHAT_TRIGGER_NODE_TYPE = _constantsLegacy00VJs.Tn;
        WorkflowStateKey = _constantsLegacy00VJs.Xs;
        WORKFLOW_SETTINGS_MODAL_KEY = _constantsLegacy00VJs.hs;
        NDV_UI_OVERHAUL_EXPERIMENT = _constantsLegacy00VJs.ic;
        START_NODE_TYPE = _constantsLegacy00VJs.lr;
        isTriggerNode = _constantsLegacy00VJs.ma;
        getNodeOutputs = _constantsLegacy00VJs.na;
        EVALUATION_NODE_TYPE = _constantsLegacy00VJs.no;
        NEW_WORKFLOW_ID = _constantsLegacy00VJs.o;
        EnterpriseEditionFeature = _constantsLegacy00VJs.pc;
        ExpressionLocalResolveContextSymbol = _constantsLegacy00VJs.qs;
        EVALUATION_TRIGGER_NODE_TYPE = _constantsLegacy00VJs.ro;
        PLACEHOLDER_EMPTY_WORKFLOW_ID = _constantsLegacy00VJs.s;
        HTML_NODE_TYPE = _constantsLegacy00VJs.so;
        getNodeInputs = _constantsLegacy00VJs.ta;
        MODAL_CONFIRM = _constantsLegacy00VJs.ts;
      ...
      }, function (_dateformatLegacy011Js) {}, function (_useDebounceLegacy013Js) {}, function (_useExternalHooksLegacy015Js) {
        useExternalHooks = _useExternalHooksLegacy015Js.t;
      }, function (_useStylesLegacy017Js) {}, function (_chatPanelStoreLegacy019Js) {}, function (_npsSurveyStoreLegacy01dJs) {
        useNpsSurveyStore = _npsSurveyStoreLegacy01dJs.t;
      }, function (_cloudPlanStoreLegacy01fJs) {}, function (_templatesStoreLegacy01hJs) {}, function (_focusPanelStoreLegacy01jJs) {
      ...
      }, function (_retryLegacy01nJs) {}, function (_executionsStoreLegacy01pJs) {
        useExecutionsStore = _executionsStoreLegacy01pJs.t;
      }, function (_useRunWorkflowLegacy01rJs) {
        usePushConnectionStore = _useRunWorkflowLegacy01rJs.i;
        useAgentRequestStore = _useRunWorkflowLegacy01rJs.n;
        useRunWorkflow = _useRunWorkflowLegacy01rJs.t;
      }, function (_usePinnedDataLegacy01tJs) {}, function (_nodeCreatorStoreLegacy01vJs) {
        useNodeCreatorStore = _nodeCreatorStoreLegacy01vJs.t;
        shouldIgnoreCanvasShortcut = _nodeCreatorStoreLegacy01vJs.u;
      }, function (_nodeIconLegacy01xJs) {}, function (_useClipboardLegacy01zJs) {
        useClipboard = _useClipboardLegacy01zJs.t;
      }, function (_useCanvasOperationsLegacy01BJs) {
        useLogsStore = _useCanvasOperationsLegacy01BJs.a;
        useExperimentalNdvStore = _useCanvasOperationsLegacy01BJs.i;
        useParentFolder = _useCanvasOperationsLegacy01BJs.n;
        canvasEventBus = _useCanvasOperationsLegacy01BJs.r;
        useCanvasOperations = _useCanvasOperationsLegacy01BJs.t;
      }, function (_foldersStoreLegacy01FJs) {}, function (_NodeIconLegacy01HJs) {
        NodeIcon_default = _NodeIconLegacy01HJs.t;
      }, function (_KeyboardShortcutTooltipLegacy01JJs) {
        KeyboardShortcutTooltip_default = _KeyboardShortcutTooltipLegacy01JJs.t;
      }, function (_useCanvasMappingLegacy01LJs) {
        ExperimentalCanvasNodeSettings_default = _useCanvasMappingLegacy01LJs.c;
        CanvasRunWorkflowButton_default = _useCanvasMappingLegacy01LJs.d;
        useGlobalLinkActions = _useCanvasMappingLegacy01LJs.l;
        Canvas_default = _useCanvasMappingLegacy01LJs.n;
        useContextMenuItems = _useCanvasMappingLegacy01LJs.o;
        useExpressionResolveCtx = _useCanvasMappingLegacy01LJs.s;
        useCanvasMapping = _useCanvasMappingLegacy01LJs.t;
        useWorkflowExtraction = _useCanvasMappingLegacy01LJs.u;
      }, function (_versionsStoreLegacy01NJs) {}, function (_usePageRedirectionHelperLegacy01PJs) {}, function (_dataTableStoreLegacy01TJs) {}, function (_isEmptyLegacy023Js) {
        JsonEditor_default = _isEmptyLegacy023Js.c;
      }, function (_NDVEmptyStateLegacy025Js) {}, function (_exportsLegacy027Js) {}, function (_externalSecretsEeStoreLegacy029Js) {
        useExternalSecretsStore = _externalSecretsEeStoreLegacy029Js.t;
      }, function (_uniqByLegacy02bJs) {}, function (_semverLegacy02dJs) {}, function (_CommunityNodeUpdateInfoLegacy02fJs) {}, function (_RunDataHtmlLegacy02pJs) {}, function (_VueMarkdownLegacy02tJs) {}, function (_DraggableLegacy02vJs) {}, function (_VirtualSchemaLegacy02xJs) {
        NodeExecuteButton_default = _VirtualSchemaLegacy02xJs.n;
      }, function (_TextWithHighlightsLegacy02zJs) {}, function (_useTelemetryContextLegacy02BJs) {
        useTelemetryContext = _useTelemetryContextLegacy02BJs.t;
      }, function (_schemaPreviewStoreLegacy02DJs) {}, function (_nodeTransformsLegacy02FJs) {
        needsAgentInput = _nodeTransformsLegacy02FJs.a;
      }, function (_FileSaverMinLegacy02JJs) {}, function (_vueJsonPrettyLegacy02LJs) {}, function (_dateFormatterLegacy02NJs) {}, function (_useExecutionHelpersLegacy02PJs) {}, function (_NodeSettingsLegacy02TJs) {}, function (_useActionsLegacy03vJs) {}, function (_vueLegacy03zJs) {}, function (_sourceControlEventBusLegacy03JJs) {
        sourceControlEventBus = _sourceControlEventBusLegacy03JJs.t;
      }, function (_useKeybindingsLegacy03NJs) {
        useKeybindings = _useKeybindingsLegacy03NJs.t;
      }, function (_useBeforeUnloadLegacy047Js) {
        useBeforeUnload = _useBeforeUnloadLegacy047Js.t;
      }, function (_aiTemplatesStarterCollectionStoreLegacy04fJs) {
        useAITemplatesStarterCollectionStore = _aiTemplatesStarterCollectionStoreLegacy04fJs.t;
      }, function (_useExecutionDataLegacy04xJs) {
        useExecutionData = _useExecutionDataLegacy04xJs.t;
      }, function (_useExecutionDebuggingLegacy04zJs) {
        useExecutionDebugging = _useExecutionDebuggingLegacy04zJs.t;
      }, function (_readyToRunWorkflowsStoreLegacy04BJs) {
        useReadyToRunWorkflowsStore = _readyToRunWorkflowsStoreLegacy04BJs.t;
      }],
      execute: function () {
        ...
        NodeView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          __name: "NodeView",
          setup(__props) {
            const LazyNodeCreation = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeCreation-legacy-C8uLHAz-.js"), true               ? void 0 : void 0));
            const LazyNodeDetailsView = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeDetailsView-legacy-BA4Dr4yJ.js"), true               ? void 0 : void 0));
            const LazyNodeDetailsViewV2 = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeDetailsViewV2-legacy-CYMDedEX.js"), true               ? void 0 : void 0));
            const LazySetupWorkflowCredentialsButton = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./SetupWorkflowCredentialsButton-legacy-D40xedQU.js"), true               ? void 0 : void 0));
            const $style = useCssModule();
