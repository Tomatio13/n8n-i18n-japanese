...
import { gt as useI18n, j as useLocalStorage } from "./_MapCache-BecNBFeT.js";
import { b as useRouter, x as createEventBus, y as useRoute } from "./truncate-BZrAdcfN.js";
import { $ as getExecutionErrorToastConfiguration, Ar as RemoveConnectionCommand, Bo as useSettingsStore, Ci as tryToParseNumber, Cr as useHistoryStore, En as useProjectsStore, G as isChatNode, Ht as useCredentialsStore, Io as v4_default, Mr as RenameNodeCommand, Ni as useUIStore, Nr as ReplaceNodeParametersCommand, S as getNodesGroupSize, Sn as injectWorkflowState, Sr as CanvasNodeRenderType, Tr as AddNodeCommand, Un as useCanvasStore, Zs as useRootStore, Zt as useDataSchema, _n as useTagsStore, a as useNDVStore, b as getNewNodePosition, bc as defineStore, br as CanvasConnectionMode, d as DEFAULT_VIEWPORT_BOUNDARIES, f as GRID_SIZE, gr as isValidNodeConnectionType, h as generateOffsets, i as usePostHog, jr as RemoveNodeCommand, kr as MoveNodeCommand, l as CONFIGURATION_NODE_SIZE, mn as useWorkflowHelpers, o as useWorkflowsStore, p as PUSH_NODES_OFFSET, rt as useNodeTypesStore, s as CONFIGURABLE_NODE_SIZE, t as useTelemetry, u as DEFAULT_NODE_SIZE, vi as isPresent, wr as AddConnectionCommand, xn as useNodeHelpers } from "./useTelemetry-Bj7xGk8p.js";
import { t as useToast } from "./useToast-DELebJfp.js";
import { Br as require_cloneDeep, En as UPDATE_WEBHOOK_ID_NODE_TYPES, Hi as deepCopy, Ms as NDV_IN_FOCUS_PANEL_EXPERIMENT, On as WEBHOOK_NODE_TYPE, Os as CANVAS_ZOOMED_VIEW_EXPERIMENT, Qr as require__baseUniq, St as FORM_TRIGGER_NODE_TYPE, Ui as isCommunityPackageName, Vs as EnterpriseEditionFeature, _i as getNodeInputs, as as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, ea as NodeConnectionTypes, gi as getConnectionTypes, is as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, mo as VIEWS, os as LOCAL_STORAGE_LOGS_PANEL_OPEN, pi as generateNodesGraph, ss as LOCAL_STORAGE_LOGS_SYNC_SELECTION, vi as getNodeOutputs, wi as getSubworkflowId, xn as STICKY_NODE_TYPE, yi as getNodeParameters, zt as MCP_TRIGGER_NODE_TYPE } from "./constants-WMddrDmV.js";
...
import { a as mapCanvasConnectionToLegacyConnection, l as parseCanvasConnectionHandleString, o as mapLegacyConnectionToCanvasConnection, r as createCanvasConnectionHandleString, s as mapLegacyConnectionsToCanvasConnections, t as useNodeCreatorStore } from "./nodeCreator.store-ObwbQXKg.js";
