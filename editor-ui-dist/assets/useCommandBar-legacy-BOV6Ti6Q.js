;
(function () {
  System.register(["./chunk-legacy-Re9CbdfL.js", "./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./_MapCache-legacy-CVC6di38.js", "./src-legacy-DaU7H7T8.js", "./_plugin-vue_export-helper-legacy-DZMI5HPp.js", "./truncate-legacy-BWR_lVFz.js", "./useMessage-legacy-C-89O3Lx.js", "./useTelemetry-legacy-DyFWt8gD.js", "./useToast-legacy-CQPpmrHA.js", "./constants-legacy-DAaX1J_j.js", "./useDebounce-legacy-B8ZMAqF7.js", "./useWorkflowSaving-legacy-7aVpp8JN.js", "./executions.store-legacy-C4aotPrS.js", "./useRunWorkflow-legacy-DYbEugng.js", "./useCanvasOperations-legacy-D-0t8lEy.js", "./folders.store-legacy-B_q2iR4A.js", "./NodeIcon-legacy-DKkXHEXu.js", "./dataTable.store-legacy-Br7hSd9b.js", "./useBugReporting-legacy-7wzpZYNG.js", "./uniqBy-legacy-DxXZ0vNA.js", "./ProjectIcon-legacy-Or2DwIMX.js", "./CredentialIcon-legacy-B_gWeYoh.js", "./FileSaver.min-legacy-BTN44Z38.js", "./useRecentResources-legacy-B6RysZII.js", "./useWorkflowActivate-legacy-BYlOAKBN.js"], function (_export, _context) {
    "use strict";

    var __toESM, computed, createElementBlock, createCommentVNode, unref, ref, createVNode, defineComponent, toDisplayString, createBlock, normalizeClass, openBlock, createTextVNode, createBaseVNode, useI18n, N8nKeyboardShortcut_default, N8nIcon_default, __plugin_vue_export_helper_default, useRouter, useRoute, useMessage, useSettingsStore, useSourceControlStore, nodeViewEventBus, useProjectsStore, useCredentialsStore, useUIStore, ProjectTypes, executionRetryMessage, useRootStore, useTagsStore, usePostHog, useActionsGenerator, useWorkflowHelpers, useWorkflowsStore, useNodeTypesStore, useTelemetry, useToast, DATA_TABLE_VIEW, isResourceLocatorValue, MODAL_CONFIRM, IMPORT_WORKFLOW_URL_MODAL_KEY, DATA_TABLE_DETAILS, WHATS_NEW_MODAL_KEY, EnterpriseEditionFeature, getResourcePermissions, EXECUTE_WORKFLOW_NODE_TYPE, ABOUT_MODAL_KEY, PROJECT_DATA_TABLES, COMMAND_BAR_EXPERIMENT, VIEWS, WORKFLOW_SETTINGS_MODAL_KEY, DUPLICATE_MODAL_KEY, require_debounce, useWorkflowSaving, useExecutionsStore, useRunWorkflow, canvasEventBus, useCanvasOperations, useFoldersStore, NodeIcon_default, useDataTableStore, EXTERNAL_LINKS, useGlobalEntityCreation, useBugReporting, require_uniqBy, isIconOrEmoji, ProjectIcon_default, CredentialIcon_default, require_FileSaver_min, useRecentResources, useWorkflowActivate, __vite_style__, CommandBarItemTitle_vue_vue_type_script_setup_true_lang_default, container, title, suffix, action, shortcut, CommandBarItemTitle_vue_vue_type_style_index_0_lang_module_default, cssModules, CommandBarItemTitle_default, ITEM_ID$7, import_FileSaver_min, import_uniqBy, ITEM_ID$6, import_debounce$2, ITEM_ID$5, import_debounce$1, ITEM_ID$4, import_debounce, ITEM_ID$3, ITEM_ID$2, ITEM_ID$1, ITEM_ID;
    ...
    return {
      setters: [function (_chunkLegacy001Js) {
        ...
        COMMAND_BAR_EXPERIMENT = _constantsLegacy00NJs.ks;
