    ...
    return {
      ...
      execute: function () {
        ...
        NodeView_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */defineComponent({
          ...
          __name: "NodeView",
          setup(__props) {
            const LazyNodeCreation = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeCreation-legacy-BfwLXnLC.js"), true               ? void 0 : void 0));
            const LazyNodeDetailsView = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeDetailsView-legacy-C2Gl1fGn.js"), true               ? void 0 : void 0));
            const LazyNodeDetailsViewV2 = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./NodeDetailsViewV2-legacy-BY6J_SI2.js"), true               ? void 0 : void 0));
            const LazySetupWorkflowCredentialsButton = defineAsyncComponent(async () => await __vitePreload(() => _context.import("./SetupWorkflowCredentialsButton-legacy-BGAO-vD6.js"), true               ? void 0 : void 0));
            const $style = useCssModule();
