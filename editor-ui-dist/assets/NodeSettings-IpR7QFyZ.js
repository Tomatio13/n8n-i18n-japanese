...
import { r as require_get, y as useRoute } from "./truncate-BZrAdcfN.js";
import { E as TitledList_default, T as useNodeCredentialOptions, d as collectParametersByTab, f as collectSettings, h as getNodeSettingsInitialValues, p as createCommonNodeSettings, t as ParameterInputList_default, u as useNodeSettingsParameters, v as nameIsParameter, w as NodeCredentials_default } from "./ParameterInputList-C4UiTR2V.js";
import { n as ElRow, t as ElCol } from "./col-wB3fwS2R.js";
import { Bo as useSettingsStore, Cr as useHistoryStore, Di as importCurlEventBus, En as useProjectsStore, Ht as useCredentialsStore, Mr as RenameNodeCommand, Ni as useUIStore, On as ProjectTypes, Ri as COMMUNITY_NODES_INSTALLATION_DOCS_URL, Sn as injectWorkflowState, Vi as COMMUNITY_PACKAGE_INSTALL_MODAL_KEY, a as useNDVStore, er as useUsersStore, it as useActionsGenerator, mn as useWorkflowHelpers, o as useWorkflowsStore, rt as useNodeTypesStore, t as useTelemetry, vt as removePreviewToken, xn as useNodeHelpers } from "./useTelemetry-Bj7xGk8p.js";
import { t as useToast } from "./useToast-DELebJfp.js";
import { Hi as deepCopy, I as CUSTOM_API_CALL_KEY, Q as CHAT_TRIGGER_NODE_TYPE, St as FORM_TRIGGER_NODE_TYPE, Ui as isCommunityPackageName, _i as getNodeInputs, c as BASE_NODE_SURVEY_URL, ea as NodeConnectionTypes, en as OPEN_URL_PANEL_TRIGGER_NODE_TYPES, f as CUSTOM_NODES_DOCS_URL, mo as VIEWS, rn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, st as DATA_TABLE_NODES, u as BUILTIN_NODES_DOCS_URL, x as NPM_PACKAGE_DOCS_BASE_URL, ya as OPEN_AI_API_CREDENTIAL_TYPE, yi as getNodeParameters, zt as MCP_TRIGGER_NODE_TYPE } from "./constants-WMddrDmV.js";
...
import { t as useNodeCreatorStore } from "./nodeCreator.store-ObwbQXKg.js";
