...
(function () {
  System.register(["./vue.runtime.esm-bundler-legacy-Bq05oSFs.js", "./useTelemetry-legacy-DyFWt8gD.js", "./constants-legacy-DAaX1J_j.js"], function (_export, _context) {
    ...
    var computed, ref, reactive, useSettingsStore, hasPermission, getCloudUserInfo, STORES, getCurrentPlan, getAdminPanelLoginCode, getCurrentUsage, useRootStore, defineStore, DateTime, CLOUD_TRIAL_CHECK_INTERVAL, DEFAULT_STATE, DYNAMIC_TRIAL_BANNER_DISMISSED_KEY, useCloudPlanStore;
    return {
      setters: [function (_vueRuntimeEsmBundlerLegacy003Js) {
        ...
        getCloudUserInfo = _useTelemetryLegacy00FJs.Hs;
        STORES = _useTelemetryLegacy00FJs.Sc;
        getCurrentPlan = _useTelemetryLegacy00FJs.Us;
        getAdminPanelLoginCode = _useTelemetryLegacy00FJs.Vs;
        getCurrentUsage = _useTelemetryLegacy00FJs.Ws;
        ...
        CLOUD_TRIAL_CHECK_INTERVAL = _constantsLegacy00NJs.Us;
      }],
      execute: function () {
