...
import { m as require_get, v as require_toString, y as require__arrayMap } from "./src-9dBEqjNT.js";
import { B as subcategorizeItems, C as useNodeTypesStore, D as finalizeItems, F as prepareCommunityNodeDetailsViewStack, Ft as useNDVStore, L as searchNodes, M as groupItemsInSections, Mt as useTelemetry, N as isAINode, O as flattenCreateElements, Or as v4_default, Q as require_upperFirst, Qr as CanvasConnectionMode, T as useEvaluationStore, V as transformNodeType, Xr as isVueFlowConnection, _r as useCanvasStore, bc as STORES, ds as useSettingsStore, et as require__createCompounder, gr as useExternalHooks, k as getAiTemplatesCallout, ki as getThemedValue, mn as useTemplatesStore, r as useUIStore, s as useWorkflowsStore, z as sortNodeCreateElements } from "./users.store-CRuM-6OK.js";
import { $ as AI_CATEGORY_MEMORY, $a as AI_TRANSFORM_NODE_TYPE, At as AGGREGATE_NODE_TYPE, Cr as XML_NODE_TYPE, Dt as TRANSFORM_DATA_SUBCATEGORY, En as MARKDOWN_NODE_TYPE, Eo as require__SetCache, Et as TEMPLATE_CATEGORY_AI, F as CUSTOM_API_CALL_KEY, Ht as COMPRESSION_NODE_TYPE, J as AI_CATEGORY_CHAINS, Jn as REMOVE_DUPLICATES_NODE_TYPE, Mi as require__arrayIncludesWith, Ni as require__arrayIncludes, Nt as AI_TRANSFORM_NODE_TYPE$1, On as MERGE_NODE_TYPE, Ot as TRIGGER_NODE_CREATOR_VIEW, Q as AI_CATEGORY_MCP_NODES, Qn as SCHEDULE_TRIGGER_NODE_TYPE, Qt as EDIT_IMAGE_NODE_TYPE, Sn as LIMIT_NODE_TYPE, St as OTHER_TRIGGER_NODES_SUBCATEGORY, Tn as MANUAL_TRIGGER_NODE_TYPE, To as require__cacheHas, Ut as CONVERT_TO_FILE_NODE_TYPE, Vt as CODE_NODE_TYPE, X as AI_CATEGORY_EMBEDDING, Xn as RSS_READ_NODE_TYPE, Xt as DATETIME_NODE_TYPE, Y as AI_CATEGORY_DOCUMENT_LOADERS, Yt as DATA_TABLE_NODE_TYPE, Z as AI_CATEGORY_LANGUAGE_MODELS, _r as WEBHOOK_NODE_TYPE, _t as FLOWS_CONTROL_SUBCATEGORY, at as AI_CATEGORY_TOOLS, bt as HUMAN_IN_THE_LOOP_CATEGORY, ci as require__baseFlatten, cn as FILTER_NODE_TYPE, dt as AI_SUBCATEGORY, ea as getNodeInputs, en as EMAIL_IMAP_NODE_TYPE, ft as AI_UNCATEGORIZED_CATEGORY, gn as IF_NODE_TYPE, gt as DEFAULT_SUBCATEGORY, ht as CORE_NODES_CATEGORY, it as AI_CATEGORY_TEXT_SPLITTERS, jt as AI_CODE_NODE_TYPE, ka as isCommunityPackageName, lt as AI_NODE_CREATOR_VIEW, mn as HTTP_REQUEST_NODE_TYPE, nt as AI_CATEGORY_RETRIEVERS, on as EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE, oo as EVALUATION_TRIGGER_NODE_TYPE, or as SPLIT_IN_BATCHES_NODE_TYPE, ot as AI_CATEGORY_VECTOR_STORES, pn as HTML_NODE_TYPE, pt as AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE, q as AI_CATEGORY_AGENTS, qa as NodeConnectionTypes, qt as CRYPTO_NODE_TYPE, rt as AI_CATEGORY_ROOT_NODES, sn as EXTRACT_FROM_FILE_NODE_TYPE, sr as SPLIT_OUT_NODE_TYPE, st as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, tn as EMAIL_SEND_NODE_TYPE, tr as SET_NODE_TYPE, tt as AI_CATEGORY_OUTPUTPARSER, un as FORM_TRIGGER_NODE_TYPE, ur as SUMMARIZE_NODE_TYPE, ut as AI_OTHERS_NODE_CREATOR_VIEW, vt as HELPERS_SUBCATEGORY, wt as REGULAR_NODE_CREATOR_VIEW, xt as NODE_CREATOR_OPEN_SOURCES, yt as HITL_SUBCATEGORY, zt as CHAT_TRIGGER_NODE_TYPE } from "./constants-jSlGi3TV.js";
import { T as require__baseUnary, r as require__baseRest, u as require_isArrayLikeObject } from "./merge-WwnMky1z.js";
import { A as defineStore } from "./_baseOrderBy-DymvjUPt.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString } from "./canvas.utils-B46ithaJ.js";
import { t as getNodeIconSource } from "./nodeIcon-BtE0OHHC.js";
