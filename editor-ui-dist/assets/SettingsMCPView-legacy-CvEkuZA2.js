...
`;
            ...
            return (_ctx, _cache) => {
              return openBlock(), createElementBlock("div", {
                ...
                [`item.homeProject`]: withCtx(({
                  item: item$2
                }) => [item$2.homeProject ? (openBlock(), createElementBlock("span", {
                  key: 0,
                  class: normalizeClass(_ctx.$style["folder-cell"])
                }, [createVNode(unref(N8nLink_default), {
        ...
        header = "_header_1ey1l_127";
        WorkflowsTable_vue_vue_type_style_index_0_lang_module_default = {
          "workflow-table-container": "_workflow-table-container_1ey1l_123",
          header,
          "workflow-table": "_workflow-table_1ey1l_123",
          "description-cell": "_description-cell_1ey1l_137",
          "description-popper": "_description-popper_1ey1l_146",
          "table-link": "_table-link_1ey1l_150",
          "link-icon": "_link-icon_1ey1l_158",
          "project-link": "_project-link_1ey1l_164",
          "folder-cell": "_folder-cell_1ey1l_171"
        }; //#endregion
